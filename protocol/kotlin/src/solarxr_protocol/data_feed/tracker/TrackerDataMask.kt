...
class TrackerDataMask : Table() {
    ...
    val rawVelocity : Boolean
        get() {
            val o = __offset(30)
            return if(o != 0) 0.toByte() != bb.get(o + bb_pos) else false
        }
    val scaledVelocity : Boolean
        get() {
            val o = __offset(32)
            return if(o != 0) 0.toByte() != bb.get(o + bb_pos) else false
        }
    companion object {
        ...
        @JvmStatic
        fun startTrackerDataMask(builder: FlatBufferBuilder) = builder.startTable(15)
        @JvmStatic
        ...
        @JvmStatic
        fun addRawVelocity(builder: FlatBufferBuilder, rawVelocity: Boolean) = builder.addBoolean(13, rawVelocity, false)
        @JvmStatic
        fun addScaledVelocity(builder: FlatBufferBuilder, scaledVelocity: Boolean) = builder.addBoolean(14, scaledVelocity, false)
        @JvmStatic
