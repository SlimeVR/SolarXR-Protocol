...
class RpcMessage private constructor() {
    companion object {
        ...
        const val UnknownHIDDeviceHandshakeNotification: UByte = 79u
        const val HIDAllReceiversCommandRequest: UByte = 80u
        const val HIDTrackerCommandRequest: UByte = 81u
