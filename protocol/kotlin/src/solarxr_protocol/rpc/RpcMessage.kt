...
class RpcMessage private constructor() {
    companion object {
        ...
        const val AddTrackerRequest: UByte = 87u
        const val AddTrackerResponse: UByte = 88u
        const val UpdateTrackerPose: UByte = 89u
        const val UpdateTrackerStatus: UByte = 90u
        const val UpdateTrackerBattery: UByte = 91u
