...
class RpcMessage private constructor() {
    companion object {
        ...
        const val ConnectToWebRTCRequest: UByte = 79u
        const val ConnectToWebRTCResponse: UByte = 80u
        const val StartVideoTrackerCalibrationRequest: UByte = 81u
        const val CancelVideoTrackerCalibrationRequest: UByte = 82u
        const val VideoTrackerCalibrationProgressResponse: UByte = 83u
