...
class ModelToggles : Table() {
    ...
    companion object {
        ...
        @JvmStatic
        fun addFingersMitten(builder: FlatBufferBuilder, fingersMitten: Boolean) = builder.addBoolean(13, fingersMitten, false)
        @JvmStatic
