...
class TrackingChecklistSteamVRDisconnected : Table() {
    ...
    companion object {
        ...
        @JvmStatic
        fun createTrackingChecklistSteamVRDisconnected(builder: FlatBufferBuilder, bridgeSettingsNameOffset: Int, driverInstalled: Boolean, driverBlockedBySafeMode: Boolean, driverEnabled: Boolean) : Int {
            builder.startTable(4)
            addBridgeSettingsName(builder, bridgeSettingsNameOffset)
            addDriverEnabled(builder, driverEnabled)
        ...
        @JvmStatic
        fun addDriverEnabled(builder: FlatBufferBuilder, driverEnabled: Boolean) = builder.addBoolean(3, driverEnabled, false)
        @JvmStatic
