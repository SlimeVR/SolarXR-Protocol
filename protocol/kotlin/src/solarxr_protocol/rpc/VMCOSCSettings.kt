...
class VMCOSCSettings : Table() {
    ...
    companion object {
        ...
        @JvmStatic
        fun createVMCOSCSettings(builder: FlatBufferBuilder, oscSettingsOffset: Int, anchorHip: Boolean) : Int {
        ...
        @JvmStatic
        fun startVMCOSCSettings(builder: FlatBufferBuilder) = builder.startTable(2)
        @JvmStatic
