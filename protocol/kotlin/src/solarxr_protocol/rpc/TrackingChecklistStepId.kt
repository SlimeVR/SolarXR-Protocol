...
class TrackingChecklistStepId private constructor() {
    companion object {
        ...
        const val STEAMVRHANDSENABLED: UByte = 11u
        const val STANDABLEINSTALLED: UByte = 12u
        val names : Array<String> = arrayOf("UNKNOWN", "TRACKERS_REST_CALIBRATION", "FULL_RESET", "VRCHAT_SETTINGS", "STEAMVR_DISCONNECTED", "UNASSIGNED_HMD", "TRACKER_ERROR", "NETWORK_PROFILE_PUBLIC", "MOUNTING_CALIBRATION", "FEET_MOUNTING_CALIBRATION", "STAY_ALIGNED_CONFIGURED", "STEAMVR_HANDS_ENABLED", "STANDABLE_INSTALLED")
        @JvmStatic
