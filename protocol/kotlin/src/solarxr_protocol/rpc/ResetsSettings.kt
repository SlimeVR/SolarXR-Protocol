...
class ResetsSettings : Table() {
    ...
    companion object {
        ...
        @JvmStatic
        fun createResetsSettings(builder: FlatBufferBuilder, resetMountingFeet: Boolean, armsMountingResetMode: UByte, yawResetSmoothTime: Float, saveMountingReset: Boolean, resetHmdPitchRoll: Boolean) : Int {
            builder.startTable(5)
            addYawResetSmoothTime(builder, yawResetSmoothTime)
            addResetHmdPitchRoll(builder, resetHmdPitchRoll)
        ...
        @JvmStatic
        fun addResetHmdPitchRoll(builder: FlatBufferBuilder, resetHmdPitchRoll: Boolean) = builder.addBoolean(4, resetHmdPitchRoll, false)
        @JvmStatic
