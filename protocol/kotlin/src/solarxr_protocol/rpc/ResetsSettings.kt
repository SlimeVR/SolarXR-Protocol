...
class ResetsSettings : Table() {
    ...
    companion object {
        ...
        @JvmStatic
        fun createResetsSettings(builder: FlatBufferBuilder, resetMountingFeet: Boolean, armsMountingResetMode: UByte, saveMountingReset: Boolean) : Int {
        ...
        @JvmStatic
        fun addSaveMountingReset(builder: FlatBufferBuilder, saveMountingReset: Boolean) = builder.addBoolean(2, saveMountingReset, false)
        @JvmStatic
