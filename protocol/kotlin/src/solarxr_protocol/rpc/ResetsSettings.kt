...
class ResetsSettings : Table() {
    ...
    companion object {
        ...
        @JvmStatic
        fun createResetsSettings(builder: FlatBufferBuilder, resetMountingFeet: Boolean, armsMountingResetMode: UByte, forceResetHmd: Boolean) : Int {
            builder.startTable(3)
            addForceResetHmd(builder, forceResetHmd)
        ...
        @JvmStatic
        fun addForceResetHmd(builder: FlatBufferBuilder, forceResetHmd: Boolean) = builder.addBoolean(2, forceResetHmd, false)
        @JvmStatic
