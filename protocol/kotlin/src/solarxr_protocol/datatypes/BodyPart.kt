...
class BodyPart private constructor() {
    companion object {
        ...
        const val LEFTTOE1: UByte = 55u
        const val LEFTTOE2: UByte = 56u
        const val LEFTTOE3: UByte = 57u
        const val RIGHTTOE1: UByte = 58u
        const val RIGHTTOE2: UByte = 59u
        const val RIGHTTOE3: UByte = 60u
