...
class BodyPart private constructor() {
    companion object {
        ...
        const val LEFTTOESABDUCTORHALLUCIS: UByte = 55u
        const val LEFTTOESDIGITORUMBREVIS: UByte = 56u
        const val LEFTTOESABDUCTORDIGITIMINIMI: UByte = 57u
        const val RIGHTTOESABDUCTORHALLUCIS: UByte = 58u
        const val RIGHTTOESDIGITORUMBREVIS: UByte = 59u
        const val RIGHTTOESABDUCTORDIGITIMINIMI: UByte = 60u
        const val LEFTHANDINPUT: UByte = 70u
        const val RIGHTHANDINPUT: UByte = 71u
