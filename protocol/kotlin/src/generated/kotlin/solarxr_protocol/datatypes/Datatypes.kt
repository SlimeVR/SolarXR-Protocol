...
public enum class BodyPart(
  ...
  LOWER_CHEST(4.toUByte()),
  UPPER_WAIST(5.toUByte()),
  LOWER_WAIST(6.toUByte()),
  HIP(7.toUByte()),
  LEFT_UPPER_LEG(8.toUByte()),
  RIGHT_UPPER_LEG(9.toUByte()),
  LEFT_LOWER_LEG(10.toUByte()),
  RIGHT_LOWER_LEG(11.toUByte()),
  LEFT_FOOT(12.toUByte()),
  RIGHT_FOOT(13.toUByte()),
  LEFT_UPPER_ARM(14.toUByte()),
  RIGHT_UPPER_ARM(15.toUByte()),
  LEFT_LOWER_ARM(16.toUByte()),
  RIGHT_LOWER_ARM(17.toUByte()),
  LEFT_HAND(18.toUByte()),
  RIGHT_HAND(19.toUByte()),
  LEFT_SHOULDER(20.toUByte()),
  RIGHT_SHOULDER(21.toUByte()),
  LEFT_THUMB_METACARPAL(22.toUByte()),
  LEFT_THUMB_PROXIMAL(23.toUByte()),
  LEFT_THUMB_DISTAL(24.toUByte()),
  LEFT_INDEX_PROXIMAL(25.toUByte()),
  LEFT_INDEX_INTERMEDIATE(26.toUByte()),
  LEFT_INDEX_DISTAL(27.toUByte()),
  LEFT_MIDDLE_PROXIMAL(28.toUByte()),
  LEFT_MIDDLE_INTERMEDIATE(29.toUByte()),
  LEFT_MIDDLE_DISTAL(30.toUByte()),
  LEFT_RING_PROXIMAL(31.toUByte()),
  LEFT_RING_INTERMEDIATE(32.toUByte()),
  LEFT_RING_DISTAL(33.toUByte()),
  LEFT_LITTLE_PROXIMAL(34.toUByte()),
  LEFT_LITTLE_INTERMEDIATE(35.toUByte()),
  LEFT_LITTLE_DISTAL(36.toUByte()),
  RIGHT_THUMB_METACARPAL(37.toUByte()),
  RIGHT_THUMB_PROXIMAL(38.toUByte()),
  RIGHT_THUMB_DISTAL(39.toUByte()),
  RIGHT_INDEX_PROXIMAL(40.toUByte()),
  RIGHT_INDEX_INTERMEDIATE(41.toUByte()),
  RIGHT_INDEX_DISTAL(42.toUByte()),
  RIGHT_MIDDLE_PROXIMAL(43.toUByte()),
  RIGHT_MIDDLE_INTERMEDIATE(44.toUByte()),
  RIGHT_MIDDLE_DISTAL(45.toUByte()),
  RIGHT_RING_PROXIMAL(46.toUByte()),
  RIGHT_RING_INTERMEDIATE(47.toUByte()),
  RIGHT_RING_DISTAL(48.toUByte()),
  RIGHT_LITTLE_PROXIMAL(49.toUByte()),
  RIGHT_LITTLE_INTERMEDIATE(50.toUByte()),
  RIGHT_LITTLE_DISTAL(51.toUByte()),
  LEFT_BIG_TOE(52.toUByte()),
  LEFT_INDEX_TOE(53.toUByte()),
  LEFT_MIDDLE_TOE(54.toUByte()),
  LEFT_RING_TOE(55.toUByte()),
  LEFT_LITTLE_TOE(56.toUByte()),
  RIGHT_BIG_TOE(57.toUByte()),
  RIGHT_INDEX_TOE(58.toUByte()),
