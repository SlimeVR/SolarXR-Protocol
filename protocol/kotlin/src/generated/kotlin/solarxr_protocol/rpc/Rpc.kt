...
public sealed interface RpcMessage {
  public companion object {
    public fun decode(
      ...
      85 -> SerialTrackerCustomCommandRequest.decode(bb, offset)
      86 -> VRCConfigSettingToggleMute.decode(bb, offset)
      87 -> TrackingChecklistRequest.decode(bb, offset)
      88 -> TrackingChecklistResponse.decode(bb, offset)
      89 -> IgnoreTrackingChecklistStepRequest.decode(bb, offset)
      90 -> StartUserHeightCalibration.decode(bb, offset)
      91 -> CancelUserHeightCalibration.decode(bb, offset)
      92 -> UserHeightRecordingStatusResponse.decode(bb, offset)
      93 -> VRCOSCSettingsRequest.decode(bb, offset)
      94 -> VRCOSCSettingsResponse.decode(bb, offset)
      95 -> ChangeVRCOSCSettingsRequest.decode(bb, offset)
      96 -> VRCOSCStatusRequest.decode(bb, offset)
      97 -> VRCOSCStatusChangeResponse.decode(bb, offset)
      98 -> KeybindRequest.decode(bb, offset)
      99 -> ChangeKeybindRequest.decode(bb, offset)
      100 -> KeybindResponse.decode(bb, offset)
      101 -> InstalledInfoRequest.decode(bb, offset)
      102 -> InstalledInfoResponse.decode(bb, offset)
      103 -> OpenKeybindSettingsRequest.decode(bb, offset)
      104 -> OpenKeybindSettingsResponse.decode(bb, offset)
      105 -> EnableSteamVRDriverRequest.decode(bb, offset)
      106 -> SetKeybindRecordingRequest.decode(bb, offset)
      107 -> KeybindActivatedResponse.decode(bb, offset)
      108 -> BoneRoutingSettingsRequest.decode(bb, offset)
      109 -> BoneRoutingSettingsResponse.decode(bb, offset)
      110 -> ChangeBoneRoutingSettingsRequest.decode(bb, offset)
      111 -> DriverSettingsRequest.decode(bb, offset)
      112 -> DriverSettingsResponse.decode(bb, offset)
      113 -> ChangeDriverSettingsRequest.decode(bb, offset)
      114 -> VMCOSCStatusRequest.decode(bb, offset)
      115 -> VMCOSCStatusChangeResponse.decode(bb, offset)
    ...
    public fun typeIndex(`value`: RpcMessage): Byte = when (value) {
      ...
      is SerialTrackerCustomCommandRequest -> 85
      is VRCConfigSettingToggleMute -> 86
      is TrackingChecklistRequest -> 87
      is TrackingChecklistResponse -> 88
      is IgnoreTrackingChecklistStepRequest -> 89
      is StartUserHeightCalibration -> 90
      is CancelUserHeightCalibration -> 91
      is UserHeightRecordingStatusResponse -> 92
      is VRCOSCSettingsRequest -> 93
      is VRCOSCSettingsResponse -> 94
      is ChangeVRCOSCSettingsRequest -> 95
      is VRCOSCStatusRequest -> 96
      is VRCOSCStatusChangeResponse -> 97
      is KeybindRequest -> 98
      is ChangeKeybindRequest -> 99
      is KeybindResponse -> 100
      is InstalledInfoRequest -> 101
      is InstalledInfoResponse -> 102
      is OpenKeybindSettingsRequest -> 103
      is OpenKeybindSettingsResponse -> 104
      is EnableSteamVRDriverRequest -> 105
      is SetKeybindRecordingRequest -> 106
      is KeybindActivatedResponse -> 107
      is BoneRoutingSettingsRequest -> 108
      is BoneRoutingSettingsResponse -> 109
      is ChangeBoneRoutingSettingsRequest -> 110
      is DriverSettingsRequest -> 111
      is DriverSettingsResponse -> 112
      is ChangeDriverSettingsRequest -> 113
      is VMCOSCStatusRequest -> 114
      is VMCOSCStatusChangeResponse -> 115
