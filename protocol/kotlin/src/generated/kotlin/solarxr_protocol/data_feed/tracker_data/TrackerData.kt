...
public data class TrackerData(
  ...
  public fun encode(builder: FlatBufferWriter): Int {
    ...
    if (temp != null) { builder.forceDefaults(true); builder.addFloat(7, temp, 0.0); builder.forceDefaults(false) }
  ...
  public companion object {
    public fun decode(bb: FlatBufferReader, tableOffset: Int): TrackerData {
      ...
      val __offset_origin = if (vtableSize > 32) bb.getShort(vtableOffset + 32).toInt() else 0
...
public data class TrackerDataMask(
  ...
  public val origin: Boolean = false,
) {
  public fun encode(builder: FlatBufferWriter): Int {
    ...
    builder.addBoolean(4, rawAcceleration, false)
    builder.addBoolean(5, temp, false)
    builder.addBoolean(6, linearAcceleration, false)
    builder.addBoolean(7, rotationReferenceAdjusted, false)
    builder.addBoolean(8, rotationIdentityAdjusted, false)
    builder.addBoolean(9, tps, false)
    builder.addBoolean(10, rawMagneticVector, false)
    builder.addBoolean(11, stayAligned, false)
    builder.addBoolean(12, origin, false)
    return builder.endTable()
  }
  ...
  public companion object {
    public fun decode(bb: FlatBufferReader, tableOffset: Int): TrackerDataMask {
      ...
      val __offset_rawAcceleration = if (vtableSize > 12) bb.getShort(vtableOffset + 12).toInt() else 0
      val __offset_temp = if (vtableSize > 14) bb.getShort(vtableOffset + 14).toInt() else 0
      val __offset_linearAcceleration = if (vtableSize > 16) bb.getShort(vtableOffset + 16).toInt() else 0
      val __offset_rotationReferenceAdjusted = if (vtableSize > 18) bb.getShort(vtableOffset + 18).toInt() else 0
      val __offset_rotationIdentityAdjusted = if (vtableSize > 20) bb.getShort(vtableOffset + 20).toInt() else 0
      val __offset_tps = if (vtableSize > 22) bb.getShort(vtableOffset + 22).toInt() else 0
      val __offset_rawMagneticVector = if (vtableSize > 24) bb.getShort(vtableOffset + 24).toInt() else 0
      val __offset_stayAligned = if (vtableSize > 26) bb.getShort(vtableOffset + 26).toInt() else 0
      val __offset_origin = if (vtableSize > 28) bb.getShort(vtableOffset + 28).toInt() else 0
      ...
      return TrackerDataMask(
              ...
              origin = if (__offset_origin != 0) bb.get(tableOffset + __offset_origin) != 0.toByte() else false
          )
    }
  }
}
