...
public final class DeviceStatus extends Table {
  ...
  public slimevr_protocol.datatypes.Vec3f position(slimevr_protocol.datatypes.Vec3f obj) { int o = __offset(14); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  public int status() { int o = __offset(16); return o != 0 ? bb.get(o + bb_pos) & 0xFF : 0; }
  ...
  public boolean editable() { int o = __offset(28); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  ...
  public static void addStatus(FlatBufferBuilder builder, int status) { builder.addByte(6, (byte) status, (byte) 0); }
  ...
  public static void addEditable(FlatBufferBuilder builder, boolean editable) { builder.addBoolean(12, editable, false); }
