...
public final class TrackerId extends Table {
   ...
   */
  public slimevr_protocol.datatypes.DeviceId deviceId() { return deviceId(new slimevr_protocol.datatypes.DeviceId()); }
  public slimevr_protocol.datatypes.DeviceId deviceId(slimevr_protocol.datatypes.DeviceId obj) { int o = __offset(4); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  /**
  ...
  public static int pack(FlatBufferBuilder builder, TrackerIdT _o) {
    ...
    addDeviceId(builder, slimevr_protocol.datatypes.DeviceId.pack(builder, _o.getDeviceId()));
