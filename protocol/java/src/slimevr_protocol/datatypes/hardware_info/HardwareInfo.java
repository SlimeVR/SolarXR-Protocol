...
public final class HardwareInfo extends Table {
  ...
  public slimevr_protocol.datatypes.hardware_info.HardwareAddress hardwareAddress() { return hardwareAddress(new slimevr_protocol.datatypes.hardware_info.HardwareAddress()); }
  public slimevr_protocol.datatypes.hardware_info.HardwareAddress hardwareAddress(slimevr_protocol.datatypes.hardware_info.HardwareAddress obj) { int o = __offset(16); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  ...
  public static int pack(FlatBufferBuilder builder, HardwareInfoT _o) {
    ...
    addHardwareAddress(builder, slimevr_protocol.datatypes.hardware_info.HardwareAddress.pack(builder, _o.getHardwareAddress()));
