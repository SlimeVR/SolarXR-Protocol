...
public final class MessageBundle extends Table {
  ...
  public slimevr_protocol.data_feed.DataFeedMessageHeader dataFeedMsgs(int j) { return dataFeedMsgs(new slimevr_protocol.data_feed.DataFeedMessageHeader(), j); }
  public slimevr_protocol.data_feed.DataFeedMessageHeader dataFeedMsgs(slimevr_protocol.data_feed.DataFeedMessageHeader obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int dataFeedMsgsLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public slimevr_protocol.data_feed.DataFeedMessageHeader.Vector dataFeedMsgsVector() { return dataFeedMsgsVector(new slimevr_protocol.data_feed.DataFeedMessageHeader.Vector()); }
  public slimevr_protocol.data_feed.DataFeedMessageHeader.Vector dataFeedMsgsVector(slimevr_protocol.data_feed.DataFeedMessageHeader.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public slimevr_protocol.rpc.RpcMessageHeader rpcMsgs(int j) { return rpcMsgs(new slimevr_protocol.rpc.RpcMessageHeader(), j); }
  public slimevr_protocol.rpc.RpcMessageHeader rpcMsgs(slimevr_protocol.rpc.RpcMessageHeader obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int rpcMsgsLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public slimevr_protocol.rpc.RpcMessageHeader.Vector rpcMsgsVector() { return rpcMsgsVector(new slimevr_protocol.rpc.RpcMessageHeader.Vector()); }
  public slimevr_protocol.rpc.RpcMessageHeader.Vector rpcMsgsVector(slimevr_protocol.rpc.RpcMessageHeader.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public void unpackTo(MessageBundleT _o) {
    slimevr_protocol.data_feed.DataFeedMessageHeaderT[] _oDataFeedMsgs = new slimevr_protocol.data_feed.DataFeedMessageHeaderT[dataFeedMsgsLength()];
    ...
    slimevr_protocol.rpc.RpcMessageHeaderT[] _oRpcMsgs = new slimevr_protocol.rpc.RpcMessageHeaderT[rpcMsgsLength()];
  ...
  public static int pack(FlatBufferBuilder builder, MessageBundleT _o) {
    ...
    if (_o.getDataFeedMsgs() != null) {
      ...
      int _j = 0;
      for (slimevr_protocol.data_feed.DataFeedMessageHeaderT _e : _o.getDataFeedMsgs()) { __dataFeedMsgs[_j] = slimevr_protocol.data_feed.DataFeedMessageHeader.pack(builder, _e); _j++;}
    ...
    if (_o.getRpcMsgs() != null) {
      ...
      int _j = 0;
      for (slimevr_protocol.rpc.RpcMessageHeaderT _e : _o.getRpcMsgs()) { __rpcMsgs[_j] = slimevr_protocol.rpc.RpcMessageHeader.pack(builder, _e); _j++;}
