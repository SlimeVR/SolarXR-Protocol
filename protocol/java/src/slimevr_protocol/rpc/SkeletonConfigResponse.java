...
public final class SkeletonConfigResponse extends Table {
  ...
  public slimevr_protocol.rpc.SkeletonPart skeletonParts(int j) { return skeletonParts(new slimevr_protocol.rpc.SkeletonPart(), j); }
  public slimevr_protocol.rpc.SkeletonPart skeletonParts(slimevr_protocol.rpc.SkeletonPart obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int skeletonPartsLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public slimevr_protocol.rpc.SkeletonPart.Vector skeletonPartsVector() { return skeletonPartsVector(new slimevr_protocol.rpc.SkeletonPart.Vector()); }
  public slimevr_protocol.rpc.SkeletonPart.Vector skeletonPartsVector(slimevr_protocol.rpc.SkeletonPart.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public void unpackTo(SkeletonConfigResponseT _o) {
    slimevr_protocol.rpc.SkeletonPartT[] _oSkeletonParts = new slimevr_protocol.rpc.SkeletonPartT[skeletonPartsLength()];
  ...
  public static int pack(FlatBufferBuilder builder, SkeletonConfigResponseT _o) {
    ...
    if (_o.getSkeletonParts() != null) {
      ...
      int _j = 0;
      for (slimevr_protocol.rpc.SkeletonPartT _e : _o.getSkeletonParts()) { __skeletonParts[_j] = slimevr_protocol.rpc.SkeletonPart.pack(builder, _e); _j++;}
