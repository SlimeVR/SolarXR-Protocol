...
public final class DataFeedMessageHeader extends Table {
  ...
  public void unpackTo(DataFeedMessageHeaderT _o) {
    slimevr_protocol.data_feed.DataFeedMessageUnion _oMessage = new slimevr_protocol.data_feed.DataFeedMessageUnion();
    byte _oMessageType = messageType();
    _oMessage.setType(_oMessageType);
    Table _oMessageValue;
    switch (_oMessageType) {
      case slimevr_protocol.data_feed.DataFeedMessage.PollDataFeed:
        _oMessageValue = message(new slimevr_protocol.data_feed.PollDataFeed());
        _oMessage.setValue(_oMessageValue != null ? ((slimevr_protocol.data_feed.PollDataFeed) _oMessageValue).unpack() : null);
        break;
      case slimevr_protocol.data_feed.DataFeedMessage.StartDataFeed:
        _oMessageValue = message(new slimevr_protocol.data_feed.StartDataFeed());
        _oMessage.setValue(_oMessageValue != null ? ((slimevr_protocol.data_feed.StartDataFeed) _oMessageValue).unpack() : null);
        break;
      case slimevr_protocol.data_feed.DataFeedMessage.DataFeedUpdate:
        _oMessageValue = message(new slimevr_protocol.data_feed.DataFeedUpdate());
        _oMessage.setValue(_oMessageValue != null ? ((slimevr_protocol.data_feed.DataFeedUpdate) _oMessageValue).unpack() : null);
        break;
      case slimevr_protocol.data_feed.DataFeedMessage.DataFeedConfig:
        _oMessageValue = message(new slimevr_protocol.data_feed.DataFeedConfig());
        _oMessage.setValue(_oMessageValue != null ? ((slimevr_protocol.data_feed.DataFeedConfig) _oMessageValue).unpack() : null);
        break;
      default: break;
    }
  ...
  public static int pack(FlatBufferBuilder builder, DataFeedMessageHeaderT _o) {
    if (_o == null) return 0;
    byte _messageType = _o.getMessage() == null ? slimevr_protocol.data_feed.DataFeedMessage.NONE : _o.getMessage().getType();
    int _message = _o.getMessage() == null ? 0 : slimevr_protocol.data_feed.DataFeedMessageUnion.pack(builder, _o.getMessage());
