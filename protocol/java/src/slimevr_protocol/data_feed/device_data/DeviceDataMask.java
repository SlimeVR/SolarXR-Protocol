...
public final class DeviceDataMask extends Table {
   ...
   */
  public slimevr_protocol.data_feed.tracker.TrackerDataMask trackerData() { return trackerData(new slimevr_protocol.data_feed.tracker.TrackerDataMask()); }
  public slimevr_protocol.data_feed.tracker.TrackerDataMask trackerData(slimevr_protocol.data_feed.tracker.TrackerDataMask obj) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  /**
  ...
  public static int pack(FlatBufferBuilder builder, DeviceDataMaskT _o) {
    if (_o == null) return 0;
    int _tracker_data = _o.getTrackerData() == null ? 0 : slimevr_protocol.data_feed.tracker.TrackerDataMask.pack(builder, _o.getTrackerData());
