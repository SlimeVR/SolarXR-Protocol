...
public final class DataFeedConfig extends Table {
  ...
  public slimevr_protocol.data_feed.tracker.TrackerDataMask syntheticTrackersMask() { return syntheticTrackersMask(new slimevr_protocol.data_feed.tracker.TrackerDataMask()); }
  public slimevr_protocol.data_feed.tracker.TrackerDataMask syntheticTrackersMask(slimevr_protocol.data_feed.tracker.TrackerDataMask obj) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public static int pack(FlatBufferBuilder builder, DataFeedConfigT _o) {
    ...
    int _synthetic_trackers_mask = _o.getSyntheticTrackersMask() == null ? 0 : slimevr_protocol.data_feed.tracker.TrackerDataMask.pack(builder, _o.getSyntheticTrackersMask());
