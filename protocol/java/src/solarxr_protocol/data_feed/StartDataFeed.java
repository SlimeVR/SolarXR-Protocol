...
public final class StartDataFeed extends com.google.flatbuffers.Table {
  ...
  public solarxr_protocol.data_feed.DataFeedConfig dataFeeds(int j) { return dataFeeds(new solarxr_protocol.data_feed.DataFeedConfig(), j); }
  public solarxr_protocol.data_feed.DataFeedConfig dataFeeds(solarxr_protocol.data_feed.DataFeedConfig obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public solarxr_protocol.data_feed.DataFeedConfig.Vector dataFeedsVector(solarxr_protocol.data_feed.DataFeedConfig.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public void unpackTo(StartDataFeedT _o) {
    solarxr_protocol.data_feed.DataFeedConfigT[] _oDataFeeds = new solarxr_protocol.data_feed.DataFeedConfigT[dataFeedsLength()];
  ...
  public static int pack(FlatBufferBuilder builder, StartDataFeedT _o) {
    ...
    if (_o.getDataFeeds() != null) {
      ...
      int _j = 0;
      for (solarxr_protocol.data_feed.DataFeedConfigT _e : _o.getDataFeeds()) { __dataFeeds[_j] = solarxr_protocol.data_feed.DataFeedConfig.pack(builder, _e); _j++;}
