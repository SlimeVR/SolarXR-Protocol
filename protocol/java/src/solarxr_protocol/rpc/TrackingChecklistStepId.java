...
public final class TrackingChecklistStepId {
  ...
  public static final String[] names = { "UNKNOWN", "TRACKERS_REST_CALIBRATION", "FULL_RESET", "VRCHAT_SETTINGS", "STEAMVR_DISCONNECTED", "UNASSIGNED_HMD", "TRACKER_ERROR", "NETWORK_PROFILE_PUBLIC", "MOUNTING_CALIBRATION", "FEET_MOUNTING_CALIBRATION", "STAY_ALIGNED_CONFIGURED", "STEAMVR_HANDS_ENABLED", "STANDABLE_INSTALLED", "VRCHAT_OSC_TRACKING_DISABLED", };
