...
public final class TrackingChecklistSteamVRDisconnected extends Table {
   ...
   */
  public boolean driverEnabled() { int o = __offset(10); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  ...
  public static void addDriverEnabled(FlatBufferBuilder builder, boolean driverEnabled) { builder.addBoolean(3, driverEnabled, false); }
  ...
  public void unpackTo(TrackingChecklistSteamVRDisconnectedT _o) {
    ...
    boolean _oDriverEnabled = driverEnabled();
    _o.setDriverEnabled(_oDriverEnabled);
  }
