...
public final class TapDetectionSettings extends Table {
  ...
  public int tapResetTaps() { int o = __offset(8); return o != 0 ? bb.getShort(o + bb_pos) & 0xFFFF : 0; }
  ...
  public int tapQuickResetTaps() { int o = __offset(14); return o != 0 ? bb.getShort(o + bb_pos) & 0xFFFF : 0; }
  ...
  public int tapMountingResetTaps() { int o = __offset(20); return o != 0 ? bb.getShort(o + bb_pos) & 0xFFFF : 0; }
  ...
  public static void addTapResetTaps(FlatBufferBuilder builder, int tapResetTaps) { builder.addShort(2, (short) tapResetTaps, (short) 0); }
  ...
  public static void addTapQuickResetTaps(FlatBufferBuilder builder, int tapQuickResetTaps) { builder.addShort(5, (short) tapQuickResetTaps, (short) 0); }
  ...
  public static void addTapMountingResetTaps(FlatBufferBuilder builder, int tapMountingResetTaps) { builder.addShort(8, (short) tapMountingResetTaps, (short) 0); }
