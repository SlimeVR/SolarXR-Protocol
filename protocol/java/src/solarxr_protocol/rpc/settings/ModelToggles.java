...
public final class ModelToggles extends Table {
  ...
  public boolean hasFingersMitten() { return 0 != __offset(30); }
  public boolean fingersMitten() { int o = __offset(30); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  ...
  public static void startModelToggles(FlatBufferBuilder builder) { builder.startTable(14); }
  ...
  public static void addFingersMitten(FlatBufferBuilder builder, boolean fingersMitten) { builder.addBoolean(13, fingersMitten, false); }
  ...
  public void unpackTo(ModelTogglesT _o) {
    ...
    Boolean _oFingersMitten = hasFingersMitten() ? fingersMitten() : null;
    _o.setFingersMitten(_oFingersMitten);
  }
