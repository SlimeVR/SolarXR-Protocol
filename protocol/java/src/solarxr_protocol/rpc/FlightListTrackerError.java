...
public final class FlightListTrackerError extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_22_10_26(); }
  public static FlightListTrackerError getRootAsFlightListTrackerError(ByteBuffer _bb) { return getRootAsFlightListTrackerError(_bb, new FlightListTrackerError()); }
  public static FlightListTrackerError getRootAsFlightListTrackerError(ByteBuffer _bb, FlightListTrackerError obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public FlightListTrackerError __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createFlightListTrackerError(FlatBufferBuilder builder,
  ...
  public static void startFlightListTrackerError(FlatBufferBuilder builder) { builder.startTable(1); }
  ...
  public static int endFlightListTrackerError(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public FlightListTrackerError get(int j) { return get(new FlightListTrackerError(), j); }
    public FlightListTrackerError get(FlightListTrackerError obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
  public FlightListTrackerErrorT unpack() {
    FlightListTrackerErrorT _o = new FlightListTrackerErrorT();
    unpackTo(_o);
    return _o;
  }
  public void unpackTo(FlightListTrackerErrorT _o) {
  ...
  public static int pack(FlatBufferBuilder builder, FlightListTrackerErrorT _o) {
    if (_o == null) return 0;
    int _trackersId = 0;
    ...
    return createFlightListTrackerError(
      builder,
      _trackersId);
  }
}
