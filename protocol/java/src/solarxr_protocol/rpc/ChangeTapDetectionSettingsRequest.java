...
public final class ChangeTapDetectionSettingsRequest extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_22_10_26(); }
  public static ChangeTapDetectionSettingsRequest getRootAsChangeTapDetectionSettingsRequest(ByteBuffer _bb) { return getRootAsChangeTapDetectionSettingsRequest(_bb, new ChangeTapDetectionSettingsRequest()); }
  public static ChangeTapDetectionSettingsRequest getRootAsChangeTapDetectionSettingsRequest(ByteBuffer _bb, ChangeTapDetectionSettingsRequest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public ChangeTapDetectionSettingsRequest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createChangeTapDetectionSettingsRequest(FlatBufferBuilder builder,
    ...
    ChangeTapDetectionSettingsRequest.addYawResetDelay(builder, yawResetDelay);
    ...
    ChangeTapDetectionSettingsRequest.addSetupMode(builder, setupMode);
    ChangeTapDetectionSettingsRequest.addMountingResetTaps(builder, mountingResetTaps);
    ChangeTapDetectionSettingsRequest.addMountingResetEnabled(builder, mountingResetEnabled);
    ChangeTapDetectionSettingsRequest.addYawResetTaps(builder, yawResetTaps);
    ChangeTapDetectionSettingsRequest.addYawResetEnabled(builder, yawResetEnabled);
    ChangeTapDetectionSettingsRequest.addFullResetTaps(builder, fullResetTaps);
  ...
  public static void startChangeTapDetectionSettingsRequest(FlatBufferBuilder builder) { builder.startTable(14); }
  ...
  public static int endChangeTapDetectionSettingsRequest(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public ChangeTapDetectionSettingsRequest get(int j) { return get(new ChangeTapDetectionSettingsRequest(), j); }
    public ChangeTapDetectionSettingsRequest get(ChangeTapDetectionSettingsRequest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
  public ChangeTapDetectionSettingsRequestT unpack() {
    ChangeTapDetectionSettingsRequestT _o = new ChangeTapDetectionSettingsRequestT();
    unpackTo(_o);
    return _o;
  }
  public void unpackTo(ChangeTapDetectionSettingsRequestT _o) {
  ...
  public static int pack(FlatBufferBuilder builder, ChangeTapDetectionSettingsRequestT _o) {
    if (_o == null) return 0;
