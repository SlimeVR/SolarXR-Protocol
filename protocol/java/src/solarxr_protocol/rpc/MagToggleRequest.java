...
public final class MagToggleRequest extends com.google.flatbuffers.Table {
  ...
  public static MagToggleRequest getRootAsMagToggleRequest(ByteBuffer _bb, MagToggleRequest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public MagToggleRequest get(int j) { return get(new MagToggleRequest(), j); }
    public MagToggleRequest get(MagToggleRequest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
  public MagToggleRequestT unpack() {
    MagToggleRequestT _o = new MagToggleRequestT();
    unpackTo(_o);
    return _o;
  }
