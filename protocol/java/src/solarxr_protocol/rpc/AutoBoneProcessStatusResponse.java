...
public final class AutoBoneProcessStatusResponse extends Table {
   ...
   */
  public float eta() { int o = __offset(14); return o != 0 ? bb.getFloat(o + bb_pos) : 0.0f; }
  ...
  public static void addEta(FlatBufferBuilder builder, float eta) { builder.addFloat(5, eta, 0.0f); }
