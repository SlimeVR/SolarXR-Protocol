...
public final class TrackingChecklistTrackerError extends com.google.flatbuffers.Table {
  ...
  public static TrackingChecklistTrackerError getRootAsTrackingChecklistTrackerError(ByteBuffer _bb, TrackingChecklistTrackerError obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createTrackingChecklistTrackerError(FlatBufferBuilder builder,
  ...
  public static int endTrackingChecklistTrackerError(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public TrackingChecklistTrackerError get(int j) { return get(new TrackingChecklistTrackerError(), j); }
    public TrackingChecklistTrackerError get(TrackingChecklistTrackerError obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
  public TrackingChecklistTrackerErrorT unpack() {
    TrackingChecklistTrackerErrorT _o = new TrackingChecklistTrackerErrorT();
    unpackTo(_o);
    return _o;
  }
  public void unpackTo(TrackingChecklistTrackerErrorT _o) {
  ...
  public static int pack(FlatBufferBuilder builder, TrackingChecklistTrackerErrorT _o) {
    if (_o == null) return 0;
    int _trackersId = 0;
    ...
    return createTrackingChecklistTrackerError(
      builder,
      _trackersId);
  }
}
