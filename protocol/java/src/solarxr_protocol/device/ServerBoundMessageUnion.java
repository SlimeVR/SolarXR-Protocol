...
public class ServerBoundMessageUnion {
  ...
  public solarxr_protocol.device.commands.IChooseYouRequestT assolarxr_protocol_device_commands_IChooseYouRequest() { return (solarxr_protocol.device.commands.IChooseYouRequestT) value; }
  ...
  public static int pack(FlatBufferBuilder builder, ServerBoundMessageUnion _o) {
    switch (_o.type) {
      ...
      case ServerBoundMessage.solarxr_protocol_device_commands_IChooseYouRequest: return solarxr_protocol.device.commands.IChooseYouRequest.pack(builder, _o.assolarxr_protocol_device_commands_IChooseYouRequest());
      default: return 0;
    }
  }
}
