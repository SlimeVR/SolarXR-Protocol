...
public final class DeviceDataMask extends Table {
   ...
   */
  public solarxr_protocol.device.data_feed.tracker.TrackerDataMask trackerData() { return trackerData(new solarxr_protocol.device.data_feed.tracker.TrackerDataMask()); }
  public solarxr_protocol.device.data_feed.tracker.TrackerDataMask trackerData(solarxr_protocol.device.data_feed.tracker.TrackerDataMask obj) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  /**
  ...
  public static int pack(FlatBufferBuilder builder, DeviceDataMaskT _o) {
    if (_o == null) return 0;
    int _trackerData = _o.getTrackerData() == null ? 0 : solarxr_protocol.device.data_feed.tracker.TrackerDataMask.pack(builder, _o.getTrackerData());
