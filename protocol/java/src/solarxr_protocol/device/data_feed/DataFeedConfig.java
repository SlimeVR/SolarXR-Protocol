...
public final class DataFeedConfig extends Table {
  ...
  public solarxr_protocol.device.data_feed.device_data.DeviceDataMask dataMask() { return dataMask(new solarxr_protocol.device.data_feed.device_data.DeviceDataMask()); }
  public solarxr_protocol.device.data_feed.device_data.DeviceDataMask dataMask(solarxr_protocol.device.data_feed.device_data.DeviceDataMask obj) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public static int pack(FlatBufferBuilder builder, DataFeedConfigT _o) {
    if (_o == null) return 0;
    int _dataMask = _o.getDataMask() == null ? 0 : solarxr_protocol.device.data_feed.device_data.DeviceDataMask.pack(builder, _o.getDataMask());
