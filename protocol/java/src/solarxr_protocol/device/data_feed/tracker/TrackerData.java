...
public final class TrackerData extends Table {
  ...
  public solarxr_protocol.device.data_feed.tracker.TrackerInfo info() { return info(new solarxr_protocol.device.data_feed.tracker.TrackerInfo()); }
  public solarxr_protocol.device.data_feed.tracker.TrackerInfo info(solarxr_protocol.device.data_feed.tracker.TrackerInfo obj) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public solarxr_protocol.datatypes.math.Vec3f accel() { return accel(new solarxr_protocol.datatypes.math.Vec3f()); }
  public solarxr_protocol.datatypes.math.Vec3f accel(solarxr_protocol.datatypes.math.Vec3f obj) { int o = __offset(12); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  public float magAccuracy() { int o = __offset(14); return o != 0 ? bb.getFloat(o + bb_pos) : 0.0f; }
  /**
   * Temperature in degrees celsius
   */
  public solarxr_protocol.datatypes.Temperature temp() { return temp(new solarxr_protocol.datatypes.Temperature()); }
  public solarxr_protocol.datatypes.Temperature temp(solarxr_protocol.datatypes.Temperature obj) { int o = __offset(16); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }

  public static void startTrackerData(FlatBufferBuilder builder) { builder.startTable(7); }
  ...
  public static void addAccel(FlatBufferBuilder builder, int accelOffset) { builder.addStruct(4, accelOffset, 0); }
  public static void addMagAccuracy(FlatBufferBuilder builder, float magAccuracy) { builder.addFloat(5, magAccuracy, 0.0f); }
  public static void addTemp(FlatBufferBuilder builder, int tempOffset) { builder.addStruct(6, tempOffset, 0); }
  ...
  public void unpackTo(TrackerDataT _o) {
    ...
    if (accel() != null) accel().unpackTo(_o.getAccel());
    else _o.setAccel(null);
    float _oMagAccuracy = magAccuracy();
    _o.setMagAccuracy(_oMagAccuracy);
  ...
  public static int pack(FlatBufferBuilder builder, TrackerDataT _o) {
    ...
    int _info = _o.getInfo() == null ? 0 : solarxr_protocol.device.data_feed.tracker.TrackerInfo.pack(builder, _o.getInfo());
    ...
    addAccel(builder, solarxr_protocol.datatypes.math.Vec3f.pack(builder, _o.getAccel()));
    addMagAccuracy(builder, _o.getMagAccuracy());
