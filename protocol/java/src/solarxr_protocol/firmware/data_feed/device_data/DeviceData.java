...
package solarxr_protocol.firmware.data_feed.device_data;
...
public final class DeviceData extends Table {
   ...
   */
  public solarxr_protocol.firmware.data_feed.tracker.TrackerData trackers(int j) { return trackers(new solarxr_protocol.firmware.data_feed.tracker.TrackerData(), j); }
  public solarxr_protocol.firmware.data_feed.tracker.TrackerData trackers(solarxr_protocol.firmware.data_feed.tracker.TrackerData obj, int j) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int trackersLength() { int o = __offset(12); return o != 0 ? __vector_len(o) : 0; }
  public solarxr_protocol.firmware.data_feed.tracker.TrackerData.Vector trackersVector() { return trackersVector(new solarxr_protocol.firmware.data_feed.tracker.TrackerData.Vector()); }
  public solarxr_protocol.firmware.data_feed.tracker.TrackerData.Vector trackersVector(solarxr_protocol.firmware.data_feed.tracker.TrackerData.Vector obj) { int o = __offset(12); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public void unpackTo(DeviceDataT _o) {
    ...
    solarxr_protocol.firmware.data_feed.tracker.TrackerDataT[] _oTrackers = new solarxr_protocol.firmware.data_feed.tracker.TrackerDataT[trackersLength()];
  ...
  public static int pack(FlatBufferBuilder builder, DeviceDataT _o) {
    ...
    if (_o.getTrackers() != null) {
      ...
      int _j = 0;
      for (solarxr_protocol.firmware.data_feed.tracker.TrackerDataT _e : _o.getTrackers()) { __trackers[_j] = solarxr_protocol.firmware.data_feed.tracker.TrackerData.pack(builder, _e); _j++;}
