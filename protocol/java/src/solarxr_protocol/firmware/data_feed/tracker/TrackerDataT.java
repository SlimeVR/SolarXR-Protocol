...
public class TrackerDataT {
  ...
  private solarxr_protocol.firmware.data_feed.tracker.TrackerInfoT info;
  private int status;
  ...
  public solarxr_protocol.firmware.data_feed.tracker.TrackerInfoT getInfo() { return info; }

  public void setInfo(solarxr_protocol.firmware.data_feed.tracker.TrackerInfoT info) { this.info = info; }
