...
public final class PollDataFeed extends Table {
  ...
  public solarxr_protocol.firmware.data_feed.DataFeedConfig config() { return config(new solarxr_protocol.firmware.data_feed.DataFeedConfig()); }
  public solarxr_protocol.firmware.data_feed.DataFeedConfig config(solarxr_protocol.firmware.data_feed.DataFeedConfig obj) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public static int pack(FlatBufferBuilder builder, PollDataFeedT _o) {
    if (_o == null) return 0;
    int _config = _o.getConfig() == null ? 0 : solarxr_protocol.firmware.data_feed.DataFeedConfig.pack(builder, _o.getConfig());
