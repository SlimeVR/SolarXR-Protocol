...
#ifndef FLATBUFFERS_GENERATED_FIRMWARE_SLIMEVR_PROTOCOL_FIRMWARE_H_
#define FLATBUFFERS_GENERATED_FIRMWARE_SLIMEVR_PROTOCOL_FIRMWARE_H_

#include "flatbuffers/flatbuffers.h"

#include "datatypes_generated.h"
#include "misc_generated.h"
...
inline const char * const *EnumNamesInboundUnion() {
  static const char * const names[9] = {
    ...
    "LogData",
    "SensorReport",
    "slimevr_protocol_misc_Acknowledgement",
    "HeartbeatRequest",
    "HandshakeRequest",
...
template<> struct InboundUnionTraits<slimevr_protocol::firmware::LogData> {
  static const InboundUnion enum_value = InboundUnion::LogData;
};

template<> struct InboundUnionTraits<slimevr_protocol::firmware::SensorReport> {
  static const InboundUnion enum_value = InboundUnion::SensorReport;
};

template<> struct InboundUnionTraits<slimevr_protocol::misc::Acknowledgement> {
  static const InboundUnion enum_value = InboundUnion::slimevr_protocol_misc_Acknowledgement;
};

template<> struct InboundUnionTraits<slimevr_protocol::firmware::HeartbeatRequest> {
  static const InboundUnion enum_value = InboundUnion::HeartbeatRequest;
};

template<> struct InboundUnionTraits<slimevr_protocol::firmware::HandshakeRequest> {
...
template<> struct InboundUnionTraits<slimevr_protocol::firmware::DeviceStatusResponse> {
...
template<> struct OutboundUnionTraits<slimevr_protocol::firmware::ConfigureSensorReporting> {
  static const OutboundUnion enum_value = OutboundUnion::ConfigureSensorReporting;
};

template<> struct OutboundUnionTraits<slimevr_protocol::misc::Acknowledgement> {
  static const OutboundUnion enum_value = OutboundUnion::slimevr_protocol_misc_Acknowledgement;
};

template<> struct OutboundUnionTraits<slimevr_protocol::firmware::HeartbeatRequest> {
  static const OutboundUnion enum_value = OutboundUnion::HeartbeatRequest;
};

template<> struct OutboundUnionTraits<slimevr_protocol::firmware::DeviceInfoRequest> {
  static const OutboundUnion enum_value = OutboundUnion::DeviceInfoRequest;
};

template<> struct OutboundUnionTraits<slimevr_protocol::firmware::DeviceStatusRequest> {
...
struct InboundPacket FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  slimevr_protocol::firmware::InboundUnion packet_type() const {
    return static_cast<slimevr_protocol::firmware::InboundUnion>(GetField<uint8_t>(VT_PACKET_TYPE, 0));
  }
  const void *packet() const {
    return GetPointer<const void *>(VT_PACKET);
  }
  template<typename T> const T *packet_as() const;
  const slimevr_protocol::firmware::LogData *packet_as_LogData() const {
    return packet_type() == slimevr_protocol::firmware::InboundUnion::LogData ? static_cast<const slimevr_protocol::firmware::LogData *>(packet()) : nullptr;
  }
  const slimevr_protocol::firmware::SensorReport *packet_as_SensorReport() const {
    return packet_type() == slimevr_protocol::firmware::InboundUnion::SensorReport ? static_cast<const slimevr_protocol::firmware::SensorReport *>(packet()) : nullptr;
  }
  const slimevr_protocol::misc::Acknowledgement *packet_as_slimevr_protocol_misc_Acknowledgement() const {
    return packet_type() == slimevr_protocol::firmware::InboundUnion::slimevr_protocol_misc_Acknowledgement ? static_cast<const slimevr_protocol::misc::Acknowledgement *>(packet()) : nullptr;
  }
  const slimevr_protocol::firmware::HeartbeatRequest *packet_as_HeartbeatRequest() const {
    return packet_type() == slimevr_protocol::firmware::InboundUnion::HeartbeatRequest ? static_cast<const slimevr_protocol::firmware::HeartbeatRequest *>(packet()) : nullptr;
  }
  const slimevr_protocol::firmware::HandshakeRequest *packet_as_HandshakeRequest() const {
    return packet_type() == slimevr_protocol::firmware::InboundUnion::HandshakeRequest ? static_cast<const slimevr_protocol::firmware::HandshakeRequest *>(packet()) : nullptr;
  }
  const slimevr_protocol::hardware_info::DeviceInfo *packet_as_slimevr_protocol_hardware_info_DeviceInfo() const {
    return packet_type() == slimevr_protocol::firmware::InboundUnion::slimevr_protocol_hardware_info_DeviceInfo ? static_cast<const slimevr_protocol::hardware_info::DeviceInfo *>(packet()) : nullptr;
  }
  const slimevr_protocol::firmware::DeviceStatusResponse *packet_as_DeviceStatusResponse() const {
    return packet_type() == slimevr_protocol::firmware::InboundUnion::DeviceStatusResponse ? static_cast<const slimevr_protocol::firmware::DeviceStatusResponse *>(packet()) : nullptr;
  }
...
template<> inline const slimevr_protocol::firmware::LogData *InboundPacket::packet_as<slimevr_protocol::firmware::LogData>() const {
  return packet_as_LogData();
}

template<> inline const slimevr_protocol::firmware::SensorReport *InboundPacket::packet_as<slimevr_protocol::firmware::SensorReport>() const {
  return packet_as_SensorReport();
}

template<> inline const slimevr_protocol::misc::Acknowledgement *InboundPacket::packet_as<slimevr_protocol::misc::Acknowledgement>() const {
  return packet_as_slimevr_protocol_misc_Acknowledgement();
}

template<> inline const slimevr_protocol::firmware::HeartbeatRequest *InboundPacket::packet_as<slimevr_protocol::firmware::HeartbeatRequest>() const {
  return packet_as_HeartbeatRequest();
}

template<> inline const slimevr_protocol::firmware::HandshakeRequest *InboundPacket::packet_as<slimevr_protocol::firmware::HandshakeRequest>() const {
...
template<> inline const slimevr_protocol::firmware::DeviceStatusResponse *InboundPacket::packet_as<slimevr_protocol::firmware::DeviceStatusResponse>() const {
...
struct InboundPacketBuilder {
  ...
  void add_packet_type(slimevr_protocol::firmware::InboundUnion packet_type) {
...
inline flatbuffers::Offset<InboundPacket> CreateInboundPacket(
    ...
    slimevr_protocol::firmware::InboundUnion packet_type = slimevr_protocol::firmware::InboundUnion::NONE,
...
struct OutboundPacket FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  slimevr_protocol::firmware::OutboundUnion packet_type() const {
    return static_cast<slimevr_protocol::firmware::OutboundUnion>(GetField<uint8_t>(VT_PACKET_TYPE, 0));
  }
  const void *packet() const {
    return GetPointer<const void *>(VT_PACKET);
  }
  template<typename T> const T *packet_as() const;
  const slimevr_protocol::firmware::ConfigureSensorReporting *packet_as_ConfigureSensorReporting() const {
    return packet_type() == slimevr_protocol::firmware::OutboundUnion::ConfigureSensorReporting ? static_cast<const slimevr_protocol::firmware::ConfigureSensorReporting *>(packet()) : nullptr;
  }
  const slimevr_protocol::misc::Acknowledgement *packet_as_slimevr_protocol_misc_Acknowledgement() const {
    return packet_type() == slimevr_protocol::firmware::OutboundUnion::slimevr_protocol_misc_Acknowledgement ? static_cast<const slimevr_protocol::misc::Acknowledgement *>(packet()) : nullptr;
  }
  const slimevr_protocol::firmware::HeartbeatRequest *packet_as_HeartbeatRequest() const {
    return packet_type() == slimevr_protocol::firmware::OutboundUnion::HeartbeatRequest ? static_cast<const slimevr_protocol::firmware::HeartbeatRequest *>(packet()) : nullptr;
  }
  const slimevr_protocol::firmware::DeviceInfoRequest *packet_as_DeviceInfoRequest() const {
    return packet_type() == slimevr_protocol::firmware::OutboundUnion::DeviceInfoRequest ? static_cast<const slimevr_protocol::firmware::DeviceInfoRequest *>(packet()) : nullptr;
  }
  const slimevr_protocol::firmware::DeviceStatusRequest *packet_as_DeviceStatusRequest() const {
    return packet_type() == slimevr_protocol::firmware::OutboundUnion::DeviceStatusRequest ? static_cast<const slimevr_protocol::firmware::DeviceStatusRequest *>(packet()) : nullptr;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint64_t>(verifier, VT_PACKET_COUNTER, 8) &&
...
template<> inline const slimevr_protocol::firmware::ConfigureSensorReporting *OutboundPacket::packet_as<slimevr_protocol::firmware::ConfigureSensorReporting>() const {
  return packet_as_ConfigureSensorReporting();
}

template<> inline const slimevr_protocol::misc::Acknowledgement *OutboundPacket::packet_as<slimevr_protocol::misc::Acknowledgement>() const {
  return packet_as_slimevr_protocol_misc_Acknowledgement();
}

template<> inline const slimevr_protocol::firmware::HeartbeatRequest *OutboundPacket::packet_as<slimevr_protocol::firmware::HeartbeatRequest>() const {
  return packet_as_HeartbeatRequest();
}

template<> inline const slimevr_protocol::firmware::DeviceInfoRequest *OutboundPacket::packet_as<slimevr_protocol::firmware::DeviceInfoRequest>() const {
  return packet_as_DeviceInfoRequest();
}

template<> inline const slimevr_protocol::firmware::DeviceStatusRequest *OutboundPacket::packet_as<slimevr_protocol::firmware::DeviceStatusRequest>() const {
...
struct OutboundPacketBuilder {
  ...
  void add_packet_type(slimevr_protocol::firmware::OutboundUnion packet_type) {
...
inline flatbuffers::Offset<OutboundPacket> CreateOutboundPacket(
    ...
    uint64_t packet_counter = 0,
    bool acknowledge_me = false,
    slimevr_protocol::firmware::OutboundUnion packet_type = slimevr_protocol::firmware::OutboundUnion::NONE,
    flatbuffers::Offset<void> packet = 0) {
...
inline flatbuffers::Offset<LogData> CreateLogDataDirect(
  ...
  return slimevr_protocol::firmware::CreateLogData(
      _fbb,
      message__,
      data__);
}
...
inline flatbuffers::Offset<SensorReport> CreateSensorReportDirect(
  ...
  return slimevr_protocol::firmware::CreateSensorReport(
      _fbb,
      orientation__,
      raw_trans_accel__,
      raw_rot_vel__);
...
inline flatbuffers::Offset<DeviceStatusResponse> CreateDeviceStatusResponseDirect(
  ...
  return slimevr_protocol::firmware::CreateDeviceStatusResponse(
      _fbb,
      rssi,
      imu_status__,
      mcu_status,
...
inline bool VerifyInboundUnion(flatbuffers::Verifier &verifier, const void *obj, InboundUnion type) {
  switch (type) {
    ...
    case InboundUnion::LogData: {
      auto ptr = reinterpret_cast<const slimevr_protocol::firmware::LogData *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case InboundUnion::SensorReport: {
      auto ptr = reinterpret_cast<const slimevr_protocol::firmware::SensorReport *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case InboundUnion::slimevr_protocol_misc_Acknowledgement: {
      auto ptr = reinterpret_cast<const slimevr_protocol::misc::Acknowledgement *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case InboundUnion::HeartbeatRequest: {
      auto ptr = reinterpret_cast<const slimevr_protocol::firmware::HeartbeatRequest *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case InboundUnion::HandshakeRequest: {
      auto ptr = reinterpret_cast<const slimevr_protocol::firmware::HandshakeRequest *>(obj);
      return verifier.VerifyTable(ptr);
    }
    ...
    case InboundUnion::DeviceStatusResponse: {
      auto ptr = reinterpret_cast<const slimevr_protocol::firmware::DeviceStatusResponse *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline bool VerifyOutboundUnion(flatbuffers::Verifier &verifier, const void *obj, OutboundUnion type) {
  switch (type) {
    ...
    case OutboundUnion::ConfigureSensorReporting: {
      auto ptr = reinterpret_cast<const slimevr_protocol::firmware::ConfigureSensorReporting *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case OutboundUnion::slimevr_protocol_misc_Acknowledgement: {
      auto ptr = reinterpret_cast<const slimevr_protocol::misc::Acknowledgement *>(obj);
      return verifier.VerifyTable(ptr);
    }
    ...
    case OutboundUnion::DeviceInfoRequest: {
      auto ptr = reinterpret_cast<const slimevr_protocol::firmware::DeviceInfoRequest *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case OutboundUnion::DeviceStatusRequest: {
      auto ptr = reinterpret_cast<const slimevr_protocol::firmware::DeviceStatusRequest *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
#endif  // FLATBUFFERS_GENERATED_FIRMWARE_SLIMEVR_PROTOCOL_FIRMWARE_H_
