...
struct ResetsSettings FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool force_reset_hmd() const {
    return GetField<uint8_t>(VT_FORCE_RESET_HMD, 0) != 0;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint8_t>(verifier, VT_RESET_MOUNTING_FEET, 1) &&
           VerifyField<uint8_t>(verifier, VT_ARMS_MOUNTING_RESET_MODE, 1) &&
           VerifyField<uint8_t>(verifier, VT_FORCE_RESET_HMD, 1) &&
           verifier.EndTable();
  }
};
...
struct ResetsSettingsBuilder {
  ...
  void add_force_reset_hmd(bool force_reset_hmd) {
    fbb_.AddElement<uint8_t>(ResetsSettings::VT_FORCE_RESET_HMD, static_cast<uint8_t>(force_reset_hmd), 0);
  }
...
inline flatbuffers::Offset<ResetsSettings> CreateResetsSettings(
    ...
    bool force_reset_hmd = false) {
  ResetsSettingsBuilder builder_(_fbb);
  builder_.add_force_reset_hmd(force_reset_hmd);
