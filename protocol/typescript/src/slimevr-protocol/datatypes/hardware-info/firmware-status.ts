...
import { FirmwareErrorCode } from '../../../slimevr-protocol/datatypes/firmware-error-code';
import { LogData, LogDataT } from '../../../slimevr-protocol/datatypes/log-data';
...
export class FirmwareStatus {
  ...
  bb_pos = 0;
__init(i:number, bb:flatbuffers.ByteBuffer):FirmwareStatus {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsFirmwareStatus(bb:flatbuffers.ByteBuffer, obj?:FirmwareStatus):FirmwareStatus {
  return (obj || new FirmwareStatus()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsFirmwareStatus(bb:flatbuffers.ByteBuffer, obj?:FirmwareStatus):FirmwareStatus {
...
static startFirmwareStatus(builder:flatbuffers.Builder) {
...
static endFirmwareStatus(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}


unpack(): FirmwareStatusT {
  return new FirmwareStatusT(
    this.errorStatus(),
    this.tps(),
    this.ping(),
    this.rssi(),
...
unpackTo(_o: FirmwareStatusT): void {
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  FirmwareStatus.startFirmwareStatus(builder);
  if (this.errorStatus !== null)
    FirmwareStatus.addErrorStatus(builder, this.errorStatus);
  if (this.tps !== null)
    FirmwareStatus.addTps(builder, this.tps);
  if (this.ping !== null)
    FirmwareStatus.addPing(builder, this.ping);
  if (this.rssi !== null)
    FirmwareStatus.addRssi(builder, this.rssi);
  if (this.mcuTemp !== null)
    FirmwareStatus.addMcuTemp(builder, this.mcuTemp);
  if (this.batteryVoltage !== null)
    FirmwareStatus.addBatteryVoltage(builder, this.batteryVoltage);
  if (this.batteryPctEstimate !== null)
    FirmwareStatus.addBatteryPctEstimate(builder, this.batteryPctEstimate);
  FirmwareStatus.addLogData(builder, logData);
