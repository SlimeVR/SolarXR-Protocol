...
import { FilteringSettings, FilteringSettingsT } from '../../slimevr-protocol/server/filtering-settings';
import { SteamVRTrackersSetting, SteamVRTrackersSettingT } from '../../slimevr-protocol/server/steam-vrtrackers-setting';
