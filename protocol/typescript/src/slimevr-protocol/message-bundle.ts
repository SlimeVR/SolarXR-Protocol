...
import { DataFeedMessageHeader, DataFeedMessageHeaderT } from '../slimevr-protocol/data-feed/data-feed-message-header';
import { RpcMessageHeader, RpcMessageHeaderT } from '../slimevr-protocol/rpc/rpc-message-header';
