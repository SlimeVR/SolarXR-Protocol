...
import { TrackerInfo, TrackerInfoT } from '../../../../solarxr-protocol/device/data-feed/tracker/tracker-info';
...
static addAccel(builder:flatbuffers.Builder, accelOffset:flatbuffers.Offset) {
  builder.addFieldStruct(4, accelOffset, 0);
}

static addMagAccuracy(builder:flatbuffers.Builder, magAccuracy:number) {
  builder.addFieldFloat32(5, magAccuracy, 0.0);
}

static addTemp(builder:flatbuffers.Builder, tempOffset:flatbuffers.Offset) {
  builder.addFieldStruct(6, tempOffset, 0);
}
...
unpack(): TrackerDataT {
  return new TrackerDataT(
    ...
    (this.accel() !== null ? this.accel()!.unpack() : null),
    this.magAccuracy(),
...
unpackTo(_o: TrackerDataT): void {
  ...
  _o.accel = (this.accel() !== null ? this.accel()!.unpack() : null);
  _o.magAccuracy = this.magAccuracy();
...
constructor(
  ...
  public accel: Vec3fT|null = null,
  public magAccuracy: number = 0.0,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  TrackerData.addAccel(builder, (this.accel !== null ? this.accel!.pack(builder) : 0));
  TrackerData.addMagAccuracy(builder, this.magAccuracy);
