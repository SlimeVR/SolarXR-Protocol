...
export class ChangeTapDetectionSettingsRequest implements flatbuffers.IUnpackableObject<ChangeTapDetectionSettingsRequestT> {
  ...
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):ChangeTapDetectionSettingsRequest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsChangeTapDetectionSettingsRequest(bb:flatbuffers.ByteBuffer, obj?:ChangeTapDetectionSettingsRequest):ChangeTapDetectionSettingsRequest {
  return (obj || new ChangeTapDetectionSettingsRequest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsChangeTapDetectionSettingsRequest(bb:flatbuffers.ByteBuffer, obj?:ChangeTapDetectionSettingsRequest):ChangeTapDetectionSettingsRequest {
...
unpack(): ChangeTapDetectionSettingsRequestT {
  return new ChangeTapDetectionSettingsRequestT(
    this.fullResetDelay(),
...
unpackTo(_o: ChangeTapDetectionSettingsRequestT): void {
...
export class ChangeTapDetectionSettingsRequestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return ChangeTapDetectionSettingsRequest.createChangeTapDetectionSettingsRequest(builder,
    this.fullResetDelay,
    this.fullResetEnabled,
    this.fullResetTaps,
    this.yawResetDelay,
