...
export class ModelSettingsResponse implements flatbuffers.IUnpackableObject<ModelSettingsResponseT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):ModelSettingsResponse {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsModelSettingsResponse(bb:flatbuffers.ByteBuffer, obj?:ModelSettingsResponse):ModelSettingsResponse {
  return (obj || new ModelSettingsResponse()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsModelSettingsResponse(bb:flatbuffers.ByteBuffer, obj?:ModelSettingsResponse):ModelSettingsResponse {
...
static startModelSettingsResponse(builder:flatbuffers.Builder) {
...
static endModelSettingsResponse(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}


unpack(): ModelSettingsResponseT {
  return new ModelSettingsResponseT(
...
unpackTo(_o: ModelSettingsResponseT): void {
...
export class ModelSettingsResponseT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  ModelSettingsResponse.startModelSettingsResponse(builder);
  ModelSettingsResponse.addToggles(builder, toggles);
  ModelSettingsResponse.addRatios(builder, ratios);
  ModelSettingsResponse.addLegTweaks(builder, legTweaks);
  ModelSettingsResponse.addSkeletonHeight(builder, skeletonHeight);
  ModelSettingsResponse.addFiltering(builder, filtering);
