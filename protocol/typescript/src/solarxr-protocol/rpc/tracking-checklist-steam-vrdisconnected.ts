...
static addDriverEnabled(builder:flatbuffers.Builder, driverEnabled:boolean) {
  builder.addFieldInt8(3, +driverEnabled, +false);
}
...
static createTrackingChecklistSteamVRDisconnected(builder:flatbuffers.Builder, bridgeSettingsNameOffset:flatbuffers.Offset, driverInstalled:boolean, driverBlockedBySafeMode:boolean, driverEnabled:boolean):flatbuffers.Offset {
  ...
  TrackingChecklistSteamVRDisconnected.addDriverEnabled(builder, driverEnabled);
...
unpackTo(_o: TrackingChecklistSteamVRDisconnectedT): void {
  ...
  _o.driverEnabled = this.driverEnabled();
}
}
...
constructor(
  ...
  public driverEnabled: boolean = false
){}
