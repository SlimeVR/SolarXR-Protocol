...
export function unionToFlightListExtraData(
  ...
  accessor: (obj:FlightListNeedCalibration|FlightListSteamVRDisconnected|FlightListTrackerError|FlightListTrackerReset|FlightListUnassignedHMD) => FlightListNeedCalibration|FlightListSteamVRDisconnected|FlightListTrackerError|FlightListTrackerReset|FlightListUnassignedHMD|null
): FlightListNeedCalibration|FlightListSteamVRDisconnected|FlightListTrackerError|FlightListTrackerReset|FlightListUnassignedHMD|null {
...
export function unionListToFlightListExtraData(
  type: FlightListExtraData, 
  accessor: (index: number, obj:FlightListNeedCalibration|FlightListSteamVRDisconnected|FlightListTrackerError|FlightListTrackerReset|FlightListUnassignedHMD) => FlightListNeedCalibration|FlightListSteamVRDisconnected|FlightListTrackerError|FlightListTrackerReset|FlightListUnassignedHMD|null, 
  index: number
): FlightListNeedCalibration|FlightListSteamVRDisconnected|FlightListTrackerError|FlightListTrackerReset|FlightListUnassignedHMD|null {
  switch(FlightListExtraData[type]) {
    case 'NONE': return null; 
