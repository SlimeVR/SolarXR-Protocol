...
import { StartUserHeightCalibation, StartUserHeightCalibationT } from '../../solarxr-protocol/rpc/start-user-height-calibation.js';
...
export function unionToRpcMessage(
  ...
  switch(RpcMessage[type]) {
    ...
    case 'StartUserHeightCalibation': return accessor(new StartUserHeightCalibation())! as StartUserHeightCalibation;
...
export function unionListToRpcMessage(
  ...
  switch(RpcMessage[type]) {
    ...
    case 'StartUserHeightCalibation': return accessor(index, new StartUserHeightCalibation())! as StartUserHeightCalibation;
