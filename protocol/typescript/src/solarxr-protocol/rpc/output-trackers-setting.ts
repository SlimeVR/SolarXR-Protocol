...
export class OutputTrackersSetting implements flatbuffers.IUnpackableObject<OutputTrackersSettingT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):OutputTrackersSetting {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOutputTrackersSetting(bb:flatbuffers.ByteBuffer, obj?:OutputTrackersSetting):OutputTrackersSetting {
  return (obj || new OutputTrackersSetting()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOutputTrackersSetting(bb:flatbuffers.ByteBuffer, obj?:OutputTrackersSetting):OutputTrackersSetting {
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  const trackers = OutputTrackersSetting.createTrackersVector(builder, this.trackers);
