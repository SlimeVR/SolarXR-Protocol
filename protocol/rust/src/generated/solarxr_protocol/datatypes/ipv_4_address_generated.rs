...
impl<'a> flatbuffers::Follow<'a> for Ipv4Address {
  ...
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { <&'a Ipv4Address>::follow(buf, loc) }
  }
}
impl<'a> flatbuffers::Follow<'a> for &'a Ipv4Address {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { flatbuffers::follow_cast_ref::<Ipv4Address>(buf, loc) }
  }
}
impl<'b> flatbuffers::Push for Ipv4Address {
    ...
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = unsafe { ::core::slice::from_raw_parts(self as *const Ipv4Address as *const u8, <Self as flatbuffers::Push>::size()) };
