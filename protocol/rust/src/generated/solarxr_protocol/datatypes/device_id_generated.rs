...
impl flatbuffers::SafeSliceAccess for DeviceId {}
...
impl<'b> flatbuffers::Push for DeviceId {
    ...
    fn push(&self, dst: &mut [u8], _rest: &[u8]) {
        let src = unsafe {
            ::core::slice::from_raw_parts(self as *const DeviceId as *const u8, Self::size())
        };
        dst.copy_from_slice(src);
    }
}
impl<'b> flatbuffers::Push for &'b DeviceId {
    type Output = DeviceId;
