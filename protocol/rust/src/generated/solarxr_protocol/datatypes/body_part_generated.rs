...
impl BodyPart {
  ...
  pub const LEFT_SHOULDER: Self = Self(12);
  pub const RIGHT_SHOULDER: Self = Self(13);
  ...
  pub const LEFT_CONTROLLER: Self = Self(20);
  pub const RIGHT_CONTROLLER: Self = Self(21);
