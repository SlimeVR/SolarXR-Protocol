...
impl<'a> TrackerData<'a> {
  ...
  pub fn tracker_id(&self) -> Option<super::super::datatypes::TrackerId<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<super::super::datatypes::TrackerId>>(TrackerData::VT_TRACKER_ID, None)
  }
  #[inline]
  ...
  pub fn status(&self) -> super::super::datatypes::TrackerStatus {
    self._tab.get::<super::super::datatypes::TrackerStatus>(TrackerData::VT_STATUS, Some(super::super::datatypes::TrackerStatus::NONE)).unwrap()
  }
  #[inline]
  pub fn rotation(&self) -> Option<&'a super::super::datatypes::math::Quat> {
    self._tab.get::<super::super::datatypes::math::Quat>(TrackerData::VT_ROTATION, None)
  }
  /// Position, in meters
  #[inline]
  pub fn position(&self) -> Option<&'a super::super::datatypes::math::Vec3f> {
    self._tab.get::<super::super::datatypes::math::Vec3f>(TrackerData::VT_POSITION, None)
  }
  /// Raw rotational velocity, in euler angles
  #[inline]
  pub fn raw_rot_vel(&self) -> Option<&'a super::super::datatypes::math::Vec3f> {
    self._tab.get::<super::super::datatypes::math::Vec3f>(TrackerData::VT_RAW_ROT_VEL, None)
  }
  /// Raw translational acceleration, in m/s^2
  #[inline]
  pub fn raw_trans_accel(&self) -> Option<&'a super::super::datatypes::math::Vec3f> {
    self._tab.get::<super::super::datatypes::math::Vec3f>(TrackerData::VT_RAW_TRANS_ACCEL, None)
  }
  /// Temperature in degrees celsius
  #[inline]
  pub fn temp(&self) -> Option<&'a super::super::datatypes::Temperature> {
    self._tab.get::<super::super::datatypes::Temperature>(TrackerData::VT_TEMP, None)
  }
}
...
impl std::fmt::Debug for TrackerData<'_> {
