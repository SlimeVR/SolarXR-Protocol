...
impl<'a> TrackerDataMask<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    args: &'args TrackerDataMaskArgs<'args>
  ...
  #[inline]
  pub fn info(&self) -> Option<TrackerInfoMask<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<TrackerInfoMask>>(TrackerDataMask::VT_INFO, None)
  }
  #[inline]
...
impl flatbuffers::Verifiable for TrackerDataMask<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<TrackerInfoMask>>("info", Self::VT_INFO, false)?
...
pub struct TrackerDataMaskArgs<'a> {
    pub info: Option<flatbuffers::WIPOffset<TrackerInfoMask<'a>>>,
    pub status: bool,
    pub rotation: bool,
    pub position: bool,
...
impl<'a> Default for TrackerDataMaskArgs<'a> {
  #[inline]
  fn default() -> Self {
    TrackerDataMaskArgs {
      info: None,
...
impl<'a: 'b, 'b> TrackerDataMaskBuilder<'a, 'b> {
  #[inline]
  pub fn add_info(&mut self, info: flatbuffers::WIPOffset<TrackerInfoMask<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<TrackerInfoMask>>(TrackerDataMask::VT_INFO, info);
  }
  #[inline]
