...
impl<'a> Bone<'a> {
  ...
  pub fn body_part(&self) -> super::datatypes::BodyPart {
    self._tab.get::<super::datatypes::BodyPart>(Bone::VT_BODY_PART, Some(super::datatypes::BodyPart::NONE)).unwrap()
  }
  ...
  pub fn rotation_g(&self) -> Option<&'a super::datatypes::math::Quat> {
    self._tab.get::<super::datatypes::math::Quat>(Bone::VT_ROTATION_G, None)
  }
  #[inline]
  ...
  pub fn head_position_g(&self) -> Option<&'a super::datatypes::math::Vec3f> {
    self._tab.get::<super::datatypes::math::Vec3f>(Bone::VT_HEAD_POSITION_G, None)
  }
}
