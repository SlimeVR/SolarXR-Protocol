...
impl<'a> DataFeedMessageHeader<'a> {
  ...
  pub fn message_type(&self) -> DataFeedMessage {
    ...
    unsafe { self._tab.get::<DataFeedMessage>(DataFeedMessageHeader::VT_MESSAGE_TYPE, Some(DataFeedMessage::NONE)).unwrap()}
  }
  #[inline]
  pub fn message(&self) -> Option<flatbuffers::Table<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(DataFeedMessageHeader::VT_MESSAGE, None)}
  }
  #[inline]
  ...
  pub fn message_as_poll_data_feed(&self) -> Option<PollDataFeed<'a>> {
    if self.message_type() == DataFeedMessage::PollDataFeed {
      self.message().map(|t| {
       ...
       unsafe { PollDataFeed::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  pub fn message_as_start_data_feed(&self) -> Option<StartDataFeed<'a>> {
    if self.message_type() == DataFeedMessage::StartDataFeed {
      self.message().map(|t| {
       ...
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { StartDataFeed::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  pub fn message_as_data_feed_update(&self) -> Option<DataFeedUpdate<'a>> {
    if self.message_type() == DataFeedMessage::DataFeedUpdate {
      self.message().map(|t| {
       ...
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { DataFeedUpdate::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  pub fn message_as_data_feed_config(&self) -> Option<DataFeedConfig<'a>> {
    if self.message_type() == DataFeedMessage::DataFeedConfig {
      self.message().map(|t| {
       ...
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { DataFeedConfig::init_from_table(t) }
     })
    } else {
      None
    }
...
pub struct DataFeedMessageHeaderBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> DataFeedMessageHeaderBuilder<'a, 'b, A> {
  #[inline]
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> DataFeedMessageHeaderBuilder<'a, 'b, A> {
