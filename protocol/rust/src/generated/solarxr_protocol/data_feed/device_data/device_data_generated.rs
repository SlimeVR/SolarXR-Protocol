...
impl<'a> DeviceData<'a> {
  ...
  pub fn id(&self) -> Option<&'a super::super::datatypes::DeviceId> {
    self._tab.get::<super::super::datatypes::DeviceId>(DeviceData::VT_ID, None)
  }
  ...
  pub fn hardware_info(&self) -> Option<super::super::datatypes::hardware_info::HardwareInfo<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<super::super::datatypes::hardware_info::HardwareInfo>>(DeviceData::VT_HARDWARE_INFO, None)
  }
  ...
  pub fn hardware_status(&self) -> Option<super::super::datatypes::hardware_info::HardwareStatus<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<super::super::datatypes::hardware_info::HardwareStatus>>(DeviceData::VT_HARDWARE_STATUS, None)
  }
...
impl std::fmt::Debug for DeviceData<'_> {
