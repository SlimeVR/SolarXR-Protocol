...
impl Payload {
  ...
  pub const solarxr_protocol_datatypes_String: Self = Self(1);
  ...
  pub const ENUM_VALUES: &'static [Self] = &[
    Self::NONE,
    Self::solarxr_protocol_datatypes_String,
  ...
  pub fn variant_name(self) -> Option<&'static str> {
    match self {
      Self::NONE => Some("NONE"),
      Self::solarxr_protocol_datatypes_String => Some("solarxr_protocol_datatypes_String"),
