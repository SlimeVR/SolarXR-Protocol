...
impl<'a> Message<'a> {
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn payload_as_solarxr_protocol_datatypes_string(&self) -> Option<super::datatypes::String<'a>> {
    if self.payload_type() == Payload::solarxr_protocol_datatypes_String {
      self.payload().map(super::datatypes::String::init_from_table)
    } else {
      None
    }
  }
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_union::<Payload, _>("payload_type", Self::VT_PAYLOAD_TYPE, "payload", Self::VT_PAYLOAD, false, |key, v, pos| {
        match key {
          Payload::solarxr_protocol_datatypes_String => v.verify_union_variant::<flatbuffers::ForwardsUOffset<super::datatypes::String>>("Payload::solarxr_protocol_datatypes_String", pos),
    ...
    let mut ds = f.debug_struct("Message");
      ...
      match self.payload_type() {
        Payload::solarxr_protocol_datatypes_String => {
          if let Some(x) = self.payload_as_solarxr_protocol_datatypes_string() {
            ds.field("payload", &x)
          } else {
