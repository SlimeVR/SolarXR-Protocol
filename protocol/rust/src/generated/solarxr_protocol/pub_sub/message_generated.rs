...
impl<'a> Message<'a> {
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn payload_as_solarxr_protocol_datatypes_string_table(&self) -> Option<super::datatypes::StringTable<'a>> {
    if self.payload_type() == Payload::solarxr_protocol_datatypes_StringTable {
      self.payload().map(super::datatypes::StringTable::init_from_table)
    } else {
      None
    }
  }
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn payload_as_solarxr_protocol_datatypes_bytes(&self) -> Option<super::datatypes::Bytes<'a>> {
    if self.payload_type() == Payload::solarxr_protocol_datatypes_Bytes {
      self.payload().map(super::datatypes::Bytes::init_from_table)
    } else {
      None
    }
  }
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_union::<Payload, _>("payload_type", Self::VT_PAYLOAD_TYPE, "payload", Self::VT_PAYLOAD, false, |key, v, pos| {
        match key {
          Payload::solarxr_protocol_datatypes_StringTable => v.verify_union_variant::<flatbuffers::ForwardsUOffset<super::datatypes::StringTable>>("Payload::solarxr_protocol_datatypes_StringTable", pos),
          Payload::solarxr_protocol_datatypes_Bytes => v.verify_union_variant::<flatbuffers::ForwardsUOffset<super::datatypes::Bytes>>("Payload::solarxr_protocol_datatypes_Bytes", pos),
