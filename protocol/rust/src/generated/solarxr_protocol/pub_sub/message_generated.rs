...
impl<'a> Message<'a> {
  ...
  pub fn topic_type(&self) -> Topic {
    ...
    unsafe { self._tab.get::<Topic>(Message::VT_TOPIC_TYPE, Some(Topic::NONE)).unwrap()}
  }
  #[inline]
  pub fn topic(&self) -> Option<flatbuffers::Table<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(Message::VT_TOPIC, None)}
  }
  #[inline]
  ...
  pub fn payload_as_solarxr_protocol_datatypes_string_table(&self) -> Option<super::datatypes::StringTable<'a>> {
    if self.payload_type() == Payload::solarxr_protocol_datatypes_StringTable {
      self.payload().map(|t| {
       ...
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { super::datatypes::StringTable::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  pub fn payload_as_solarxr_protocol_datatypes_bytes(&self) -> Option<super::datatypes::Bytes<'a>> {
    if self.payload_type() == Payload::solarxr_protocol_datatypes_Bytes {
      self.payload().map(|t| {
       ...
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { super::datatypes::Bytes::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  pub fn payload_as_key_values(&self) -> Option<KeyValues<'a>> {
    if self.payload_type() == Payload::KeyValues {
      self.payload().map(|t| {
       ...
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { KeyValues::init_from_table(t) }
     })
    } else {
      None
    }
