...
impl<'a> TopicMapping<'a> {
  ...
  pub fn id(&self) -> Option<TopicId<'a>> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<TopicId>>(TopicMapping::VT_ID, None)}
  }
  #[inline]
  pub fn handle(&self) -> Option<TopicHandle<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<TopicHandle>>(TopicMapping::VT_HANDLE, None)}
  }
}
...
pub struct TopicMappingBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> TopicMappingBuilder<'a, 'b, A> {
  #[inline]
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> TopicMappingBuilder<'a, 'b, A> {
