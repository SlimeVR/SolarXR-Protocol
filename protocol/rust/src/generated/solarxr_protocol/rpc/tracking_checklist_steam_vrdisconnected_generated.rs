...
impl<'a> TrackingChecklistSteamVRDisconnected<'a> {
  ...
  pub const VT_DRIVER_ENABLED: flatbuffers::VOffsetT = 10;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    builder.add_driver_enabled(args.driver_enabled);
  ...
  pub fn driver_enabled(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(TrackingChecklistSteamVRDisconnected::VT_DRIVER_ENABLED, Some(false)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for TrackingChecklistSteamVRDisconnected<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<bool>("driver_enabled", Self::VT_DRIVER_ENABLED, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> TrackingChecklistSteamVRDisconnectedBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_driver_enabled(&mut self, driver_enabled: bool) {
    self.fbb_.push_slot::<bool>(TrackingChecklistSteamVRDisconnected::VT_DRIVER_ENABLED, driver_enabled, false);
  }
  #[inline]
...
impl core::fmt::Debug for TrackingChecklistSteamVRDisconnected<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("TrackingChecklistSteamVRDisconnected");
      ...
      ds.field("driver_enabled", &self.driver_enabled());
      ds.finish()
  }
}
