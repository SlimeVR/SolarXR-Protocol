...
impl<'a> ChangeResetsSettingsRequest<'a> {
  ...
  pub fn reset_hmd_attitude(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(ChangeResetsSettingsRequest::VT_RESET_HMD_ATTITUDE, Some(false)).unwrap()}
  }
}
...
impl<'a: 'b, 'b> ChangeResetsSettingsRequestBuilder<'a, 'b> {
  ...
  pub fn add_reset_hmd_attitude(&mut self, reset_hmd_attitude: bool) {
    self.fbb_.push_slot::<bool>(ChangeResetsSettingsRequest::VT_RESET_HMD_ATTITUDE, reset_hmd_attitude, false);
  }
  #[inline]
