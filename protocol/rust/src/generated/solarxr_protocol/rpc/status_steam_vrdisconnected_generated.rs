...
use super::*;
pub enum StatusSteamVRDisconnectedOffset {}
#[derive(Copy, Clone, PartialEq)]

/// SteamVR bridge is disconnected
pub struct StatusSteamVRDisconnected<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for StatusSteamVRDisconnected<'a> {
...
impl<'a: 'b, 'b> StatusSteamVRDisconnectedBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<StatusSteamVRDisconnected<'a>> {
