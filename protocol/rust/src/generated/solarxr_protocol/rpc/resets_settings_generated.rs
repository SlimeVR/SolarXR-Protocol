...
impl<'a> ResetsSettings<'a> {
  ...
  pub const VT_RESET_HMD_PITCH_ROLL: flatbuffers::VOffsetT = 12;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    builder.add_reset_hmd_pitch_roll(args.reset_hmd_pitch_roll);
  ...
  #[inline]
  pub fn reset_hmd_pitch_roll(&self) -> bool {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(ResetsSettings::VT_RESET_HMD_PITCH_ROLL, Some(false)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for ResetsSettings<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<bool>("reset_hmd_pitch_roll", Self::VT_RESET_HMD_PITCH_ROLL, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> ResetsSettingsBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_reset_hmd_pitch_roll(&mut self, reset_hmd_pitch_roll: bool) {
    self.fbb_.push_slot::<bool>(ResetsSettings::VT_RESET_HMD_PITCH_ROLL, reset_hmd_pitch_roll, false);
  }
  #[inline]
...
impl core::fmt::Debug for ResetsSettings<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("ResetsSettings");
      ...
      ds.field("reset_hmd_pitch_roll", &self.reset_hmd_pitch_roll());
      ds.finish()
  }
}
