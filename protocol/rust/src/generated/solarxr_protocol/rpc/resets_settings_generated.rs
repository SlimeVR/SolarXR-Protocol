...
impl<'a> ResetsSettings<'a> {
  ...
  pub const VT_FORCE_RESET_HMD: flatbuffers::VOffsetT = 8;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    builder.add_force_reset_hmd(args.force_reset_hmd);
  ...
  #[inline]
  pub fn force_reset_hmd(&self) -> bool {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(ResetsSettings::VT_FORCE_RESET_HMD, Some(false)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for ResetsSettings<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<bool>("force_reset_hmd", Self::VT_FORCE_RESET_HMD, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> ResetsSettingsBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_force_reset_hmd(&mut self, force_reset_hmd: bool) {
    self.fbb_.push_slot::<bool>(ResetsSettings::VT_FORCE_RESET_HMD, force_reset_hmd, false);
  }
  #[inline]
...
impl core::fmt::Debug for ResetsSettings<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("ResetsSettings");
      ...
      ds.field("force_reset_hmd", &self.force_reset_hmd());
      ds.finish()
  }
}
