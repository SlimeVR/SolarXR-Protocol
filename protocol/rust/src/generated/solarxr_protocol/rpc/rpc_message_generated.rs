...
impl RpcMessage {
  ...
  pub const EnableStayAlignedRequest: Self = Self(85);
  pub const DetectStayAlignedRelaxedPoseRequest: Self = Self(86);
  pub const ResetStayAlignedRelaxedPoseRequest: Self = Self(87);
