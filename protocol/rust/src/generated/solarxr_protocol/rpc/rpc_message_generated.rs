...
impl RpcMessage {
  ...
  pub const ConnectToWebRTCRequest: Self = Self(79);
  pub const ConnectToWebRTCResponse: Self = Self(80);
  pub const StartVideoTrackerCalibrationRequest: Self = Self(81);
  pub const CancelVideoTrackerCalibrationRequest: Self = Self(82);
  pub const VideoTrackerCalibrationProgressResponse: Self = Self(83);
  ...
  pub const ENUM_VALUES: &'static [Self] = &[
    ...
    Self::ConnectToWebRTCResponse,
    Self::StartVideoTrackerCalibrationRequest,
    Self::CancelVideoTrackerCalibrationRequest,
    Self::VideoTrackerCalibrationProgressResponse,
  ];
  ...
  pub fn variant_name(self) -> Option<&'static str> {
    match self {
      ...
      Self::ConnectToWebRTCRequest => Some("ConnectToWebRTCRequest"),
      Self::ConnectToWebRTCResponse => Some("ConnectToWebRTCResponse"),
      Self::StartVideoTrackerCalibrationRequest => Some("StartVideoTrackerCalibrationRequest"),
      Self::CancelVideoTrackerCalibrationRequest => Some("CancelVideoTrackerCalibrationRequest"),
      Self::VideoTrackerCalibrationProgressResponse => Some("VideoTrackerCalibrationProgressResponse"),
      _ => None,
    }
  }
}
