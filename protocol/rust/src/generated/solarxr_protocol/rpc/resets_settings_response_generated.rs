...
use super::*;
pub enum ResetsSettingsResponseOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct ResetsSettingsResponse<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for ResetsSettingsResponse<'a> {
  type Inner = ResetsSettingsResponse<'a>;
  #[inline]
...
impl<'a> ResetsSettingsResponse<'a> {
  ...
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    ResetsSettingsResponse { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
    args: &'args ResetsSettingsResponseArgs
  ...
  pub fn reset_positional_head_attitude(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(ResetsSettingsResponse::VT_RESET_POSITIONAL_HEAD_ATTITUDE, Some(false)).unwrap()}
  }
}

impl flatbuffers::Verifiable for ResetsSettingsResponse<'_> {
  #[inline]
  fn run_verifier(
...
pub struct ResetsSettingsResponseBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> ResetsSettingsResponseBuilder<'a, 'b> {
  #[inline]
  ...
  pub fn add_yaw_reset_smooth_time(&mut self, yaw_reset_smooth_time: f32) {
    self.fbb_.push_slot::<f32>(ResetsSettingsResponse::VT_YAW_RESET_SMOOTH_TIME, yaw_reset_smooth_time, 0.0);
  }
  #[inline]
  ...
  pub fn add_reset_positional_head_attitude(&mut self, reset_positional_head_attitude: bool) {
    self.fbb_.push_slot::<bool>(ResetsSettingsResponse::VT_RESET_POSITIONAL_HEAD_ATTITUDE, reset_positional_head_attitude, false);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> ResetsSettingsResponseBuilder<'a, 'b> {
    let start = _fbb.start_table();
    ResetsSettingsResponseBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<ResetsSettingsResponse<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for ResetsSettingsResponse<'_> {
