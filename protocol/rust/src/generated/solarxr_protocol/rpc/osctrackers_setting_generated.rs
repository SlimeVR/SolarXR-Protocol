...
impl<'a> OSCTrackersSetting<'a> {
  ...
  pub fn head(&self) -> bool {
    self._tab.get::<bool>(OSCTrackersSetting::VT_HEAD, Some(false)).unwrap()
  }
  #[inline]
  pub fn chest(&self) -> bool {
    self._tab.get::<bool>(OSCTrackersSetting::VT_CHEST, Some(false)).unwrap()
  }
  #[inline]
  ...
  pub fn elbows(&self) -> bool {
    self._tab.get::<bool>(OSCTrackersSetting::VT_ELBOWS, Some(false)).unwrap()
  }
  #[inline]
  pub fn hands(&self) -> bool {
    self._tab.get::<bool>(OSCTrackersSetting::VT_HANDS, Some(false)).unwrap()
  }
}
...
impl std::fmt::Debug for OSCTrackersSetting<'_> {
