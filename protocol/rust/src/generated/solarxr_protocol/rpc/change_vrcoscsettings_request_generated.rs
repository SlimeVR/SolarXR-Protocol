...
impl<'a> ChangeVRCOSCSettingsRequest<'a> {
  ...
  pub fn use_manual_network(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(ChangeVRCOSCSettingsRequest::VT_USE_MANUAL_NETWORK, Some(false)).unwrap()}
  }
  #[inline]
  pub fn port_in(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(ChangeVRCOSCSettingsRequest::VT_PORT_IN, Some(0)).unwrap()}
  }
  #[inline]
  pub fn port_out(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(ChangeVRCOSCSettingsRequest::VT_PORT_OUT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn address(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ChangeVRCOSCSettingsRequest::VT_ADDRESS, None)}
  }
}
...
impl<'a: 'b, 'b> ChangeVRCOSCSettingsRequestBuilder<'a, 'b> {
  ...
  pub fn add_use_manual_network(&mut self, use_manual_network: bool) {
    self.fbb_.push_slot::<bool>(ChangeVRCOSCSettingsRequest::VT_USE_MANUAL_NETWORK, use_manual_network, false);
  }
  #[inline]
  pub fn add_port_in(&mut self, port_in: u16) {
    self.fbb_.push_slot::<u16>(ChangeVRCOSCSettingsRequest::VT_PORT_IN, port_in, 0);
  }
  #[inline]
  pub fn add_port_out(&mut self, port_out: u16) {
    self.fbb_.push_slot::<u16>(ChangeVRCOSCSettingsRequest::VT_PORT_OUT, port_out, 0);
  }
  #[inline]
  pub fn add_address(&mut self, address: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ChangeVRCOSCSettingsRequest::VT_ADDRESS, address);
  }
  #[inline]
