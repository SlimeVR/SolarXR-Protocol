...
impl<'a> SettingsResponse<'a> {
  ...
  pub fn yaw_correction_settings(&self) -> Option<YawCorrectionSettings<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<YawCorrectionSettings>>(SettingsResponse::VT_YAW_CORRECTION_SETTINGS, None)}
  }
}
...
impl<'a: 'b, 'b> SettingsResponseBuilder<'a, 'b> {
  ...
  pub fn add_yaw_correction_settings(&mut self, yaw_correction_settings: flatbuffers::WIPOffset<YawCorrectionSettings<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<YawCorrectionSettings>>(SettingsResponse::VT_YAW_CORRECTION_SETTINGS, yaw_correction_settings);
  }
  #[inline]
