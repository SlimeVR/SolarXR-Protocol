...
impl<'a> SettingsResponse<'a> {
  ...
  pub fn drift_compensation(&self) -> Option<DriftCompensation<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<DriftCompensation>>(SettingsResponse::VT_DRIFT_COMPENSATION, None)}
  }
  #[inline]
...
impl<'a: 'b, 'b> SettingsResponseBuilder<'a, 'b> {
  ...
  pub fn add_drift_compensation(&mut self, drift_compensation: flatbuffers::WIPOffset<DriftCompensation<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<DriftCompensation>>(SettingsResponse::VT_DRIFT_COMPENSATION, drift_compensation);
  }
  #[inline]
