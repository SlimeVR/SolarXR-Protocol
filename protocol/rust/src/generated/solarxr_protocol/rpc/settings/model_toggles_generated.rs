...
impl<'a> ModelToggles<'a> {
  ...
  pub const VT_FINGERS_MITTEN: flatbuffers::VOffsetT = 30;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.fingers_mitten { builder.add_fingers_mitten(x); }
  ...
  #[inline]
  pub fn fingers_mitten(&self) -> Option<bool> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(ModelToggles::VT_FINGERS_MITTEN, None)}
  }
}
...
impl flatbuffers::Verifiable for ModelToggles<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<bool>("fingers_mitten", Self::VT_FINGERS_MITTEN, false)?
     .finish();
    Ok(())
  }
}
pub struct ModelTogglesArgs {
    ...
    pub fingers_mitten: Option<bool>,
}
...
impl<'a: 'b, 'b> ModelTogglesBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_fingers_mitten(&mut self, fingers_mitten: bool) {
    self.fbb_.push_slot_always::<bool>(ModelToggles::VT_FINGERS_MITTEN, fingers_mitten);
  }
  #[inline]
...
impl core::fmt::Debug for ModelToggles<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("ModelToggles");
      ...
      ds.field("fingers_mitten", &self.fingers_mitten());
      ds.finish()
  }
}
