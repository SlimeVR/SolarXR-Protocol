...
impl<'a> SkeletonProportionsResponse<'a> {
  ...
  pub const VT_SKELETON_HEIGHT: flatbuffers::VOffsetT = 6;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    builder.add_skeleton_height(args.skeleton_height);
  ...
  #[inline]
  pub fn skeleton_height(&self) -> f32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f32>(SkeletonProportionsResponse::VT_SKELETON_HEIGHT, Some(0.0)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for SkeletonProportionsResponse<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<f32>("skeleton_height", Self::VT_SKELETON_HEIGHT, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> SkeletonProportionsResponseBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_skeleton_height(&mut self, skeleton_height: f32) {
    self.fbb_.push_slot::<f32>(SkeletonProportionsResponse::VT_SKELETON_HEIGHT, skeleton_height, 0.0);
  }
  #[inline]
