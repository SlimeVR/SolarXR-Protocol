...
impl<'a> OverlayDisplayModeResponse<'a> {
  ...
  pub fn is_visible(&self) -> bool {
    ...
    unsafe { self._tab.get::<bool>(OverlayDisplayModeResponse::VT_IS_VISIBLE, Some(false)).unwrap()}
  }
  #[inline]
  pub fn is_mirrored(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(OverlayDisplayModeResponse::VT_IS_MIRRORED, Some(false)).unwrap()}
  }
}
...
pub struct OverlayDisplayModeResponseBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> OverlayDisplayModeResponseBuilder<'a, 'b, A> {
  #[inline]
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> OverlayDisplayModeResponseBuilder<'a, 'b, A> {
