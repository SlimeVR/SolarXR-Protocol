...
use super::*;
pub enum ChangeTimeoutSettingsRequestOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct ChangeTimeoutSettingsRequest<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for ChangeTimeoutSettingsRequest<'a> {
  type Inner = ChangeTimeoutSettingsRequest<'a>;
  #[inline]
...
impl<'a> ChangeTimeoutSettingsRequest<'a> {
  ...
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    ChangeTimeoutSettingsRequest { _tab: table }
  }
  #[allow(unused_mut)]
...
impl flatbuffers::Verifiable for ChangeTimeoutSettingsRequest<'_> {
  #[inline]
  fn run_verifier(
...
pub struct ChangeTimeoutSettingsRequestBuilder<'a: 'b, 'b> {
...
impl<'a: 'b, 'b> ChangeTimeoutSettingsRequestBuilder<'a, 'b> {
  ...
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> ChangeTimeoutSettingsRequestBuilder<'a, 'b> {
    ...
    ChangeTimeoutSettingsRequestBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<ChangeTimeoutSettingsRequest<'a>> {
