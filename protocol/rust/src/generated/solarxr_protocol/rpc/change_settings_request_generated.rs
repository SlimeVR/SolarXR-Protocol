...
impl<'a> ChangeSettingsRequest<'a> {
  ...
  pub fn osc_router(&self) -> Option<OSCSettings<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<OSCSettings>>(ChangeSettingsRequest::VT_OSC_ROUTER, None)}
  }
  #[inline]
  pub fn vrc_osc(&self) -> Option<OSCSettings<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<OSCSettings>>(ChangeSettingsRequest::VT_VRC_OSC, None)}
  }
  #[inline]
...
impl<'a: 'b, 'b> ChangeSettingsRequestBuilder<'a, 'b> {
  ...
  pub fn add_osc_router(&mut self, osc_router: flatbuffers::WIPOffset<OSCSettings<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<OSCSettings>>(ChangeSettingsRequest::VT_OSC_ROUTER, osc_router);
  }
  #[inline]
  pub fn add_vrc_osc(&mut self, vrc_osc: flatbuffers::WIPOffset<OSCSettings<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<OSCSettings>>(ChangeSettingsRequest::VT_VRC_OSC, vrc_osc);
  }
  #[inline]
