...
impl<'a> ChangeSettingsRequest<'a> {
  ...
  pub fn output_trackers(&self) -> Option<OutputTrackersSetting<'a>> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<OutputTrackersSetting>>(ChangeSettingsRequest::VT_OUTPUT_TRACKERS, None)}
  }
  #[inline]
...
impl<'a: 'b, 'b> ChangeSettingsRequestBuilder<'a, 'b> {
  ...
  pub fn add_output_trackers(&mut self, output_trackers: flatbuffers::WIPOffset<OutputTrackersSetting<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<OutputTrackersSetting>>(ChangeSettingsRequest::VT_OUTPUT_TRACKERS, output_trackers);
  }
  #[inline]
