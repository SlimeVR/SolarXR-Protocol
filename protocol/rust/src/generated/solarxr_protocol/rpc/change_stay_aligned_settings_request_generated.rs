...
impl<'a> ChangeStayAlignedSettingsRequest<'a> {
  ...
  pub fn hide_yaw_correction(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(ChangeStayAlignedSettingsRequest::VT_HIDE_YAW_CORRECTION, Some(false)).unwrap()}
  }
  #[inline]
  ...
  pub fn setup_complete(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(ChangeStayAlignedSettingsRequest::VT_SETUP_COMPLETE, Some(false)).unwrap()}
  }
}
...
impl<'a: 'b, 'b> ChangeStayAlignedSettingsRequestBuilder<'a, 'b> {
  ...
  pub fn add_hide_yaw_correction(&mut self, hide_yaw_correction: bool) {
    self.fbb_.push_slot::<bool>(ChangeStayAlignedSettingsRequest::VT_HIDE_YAW_CORRECTION, hide_yaw_correction, false);
  }
  #[inline]
  ...
  pub fn add_setup_complete(&mut self, setup_complete: bool) {
    self.fbb_.push_slot::<bool>(ChangeStayAlignedSettingsRequest::VT_SETUP_COMPLETE, setup_complete, false);
  }
  #[inline]
