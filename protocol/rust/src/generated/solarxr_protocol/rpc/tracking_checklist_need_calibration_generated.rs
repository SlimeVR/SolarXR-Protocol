...
use super::*;
pub enum TrackingChecklistNeedCalibrationOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct TrackingChecklistNeedCalibration<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for TrackingChecklistNeedCalibration<'a> {
  type Inner = TrackingChecklistNeedCalibration<'a>;
  #[inline]
...
impl<'a> TrackingChecklistNeedCalibration<'a> {
...
impl flatbuffers::Verifiable for TrackingChecklistNeedCalibration<'_> {
  #[inline]
  fn run_verifier(
...
impl<'a> Default for TrackingChecklistNeedCalibrationArgs<'a> {
  #[inline]
  fn default() -> Self {
    TrackingChecklistNeedCalibrationArgs {
      trackers_id: None,
    }
  }
}
...
impl<'a: 'b, 'b> TrackingChecklistNeedCalibrationBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<TrackingChecklistNeedCalibration<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for TrackingChecklistNeedCalibration<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("TrackingChecklistNeedCalibration");
