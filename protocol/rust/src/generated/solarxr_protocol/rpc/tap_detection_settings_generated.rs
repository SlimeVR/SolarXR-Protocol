...
impl<'a> TapDetectionSettings<'a> {
  ...
  pub const VT_FEEDBACK_SOUND_ENABLED: flatbuffers::VOffsetT = 22;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.feedback_sound_enabled { builder.add_feedback_sound_enabled(x); }
  ...
  #[inline]
  pub fn feedback_sound_enabled(&self) -> Option<bool> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(TapDetectionSettings::VT_FEEDBACK_SOUND_ENABLED, None)}
  }
}
...
impl flatbuffers::Verifiable for TapDetectionSettings<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<bool>("feedback_sound_enabled", Self::VT_FEEDBACK_SOUND_ENABLED, false)?
     .finish();
    Ok(())
  }
}
pub struct TapDetectionSettingsArgs {
    ...
    pub feedback_sound_enabled: Option<bool>,
}
...
impl<'a: 'b, 'b> TapDetectionSettingsBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_feedback_sound_enabled(&mut self, feedback_sound_enabled: bool) {
    self.fbb_.push_slot_always::<bool>(TapDetectionSettings::VT_FEEDBACK_SOUND_ENABLED, feedback_sound_enabled);
  }
  #[inline]
...
impl core::fmt::Debug for TapDetectionSettings<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("TapDetectionSettings");
      ...
      ds.field("feedback_sound_enabled", &self.feedback_sound_enabled());
      ds.finish()
  }
}
