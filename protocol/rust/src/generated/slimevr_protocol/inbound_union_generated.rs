...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_INBOUND_UNION: u8 = 8;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_INBOUND_UNION: [InboundUnion; 9] = [
  InboundUnion::NONE,
...
impl InboundUnion {
  ...
  pub const slimevr_protocol_data_feed_PollDataFeed: Self = Self(6);
  pub const slimevr_protocol_data_feed_DataFeedRequest: Self = Self(7);
  pub const slimevr_protocol_data_feed_DataFeedUpdate: Self = Self(8);
