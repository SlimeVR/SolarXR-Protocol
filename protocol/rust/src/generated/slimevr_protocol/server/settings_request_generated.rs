...
impl<'a> SettingsRequest<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    _args: &'args SettingsRequestArgs
...
pub struct SettingsRequestArgs {
}
impl<'a> Default for SettingsRequestArgs {
  #[inline]
  fn default() -> Self {
    SettingsRequestArgs {
    }
...
pub struct SettingsRequestBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> SettingsRequestBuilder<'a, 'b> {
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> SettingsRequestBuilder<'a, 'b> {
...
impl std::fmt::Debug for SettingsRequest<'_> {
