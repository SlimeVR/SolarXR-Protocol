...
impl<'a> AssignTrackerRequest<'a> {
  ...
  pub fn role(&self) -> TrackerRole {
    self._tab.get::<TrackerRole>(AssignTrackerRequest::VT_ROLE, Some(TrackerRole::NONE)).unwrap()
  }
  #[inline]
...
impl<'a: 'b, 'b> AssignTrackerRequestBuilder<'a, 'b> {
  ...
  pub fn add_role(&mut self, role: TrackerRole) {
    self.fbb_.push_slot::<TrackerRole>(AssignTrackerRequest::VT_ROLE, role, TrackerRole::NONE);
  }
  #[inline]
