...
impl flatbuffers::SafeSliceAccess for HzF32 {}
...
impl<'b> flatbuffers::Push for HzF32 {
    ...
    fn push(&self, dst: &mut [u8], _rest: &[u8]) {
        let src = unsafe {
            ::std::slice::from_raw_parts(self as *const HzF32 as *const u8, Self::size())
        };
        dst.copy_from_slice(src);
    }
}
impl<'b> flatbuffers::Push for &'b HzF32 {
    type Output = HzF32;
