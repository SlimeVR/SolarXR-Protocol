...
pub mod solarxr_protocol {
  ...
  pub mod connection {
    ...
    mod connection_error_data_generated;
    pub use self::connection_error_data_generated::*;
    mod connection_message_generated;
    pub use self::connection_message_generated::*;
    mod bone_registry_request_generated;
    pub use self::bone_registry_request_generated::*;
    mod bone_definition_generated;
    pub use self::bone_definition_generated::*;
    mod bone_registry_generated;
    pub use self::bone_registry_generated::*;
    ...
    mod configuration_done_generated;
    pub use self::configuration_done_generated::*;
    mod unknown_bone_error_generated;
    pub use self::unknown_bone_error_generated::*;
    mod invalid_registry_error_generated;
    ...
    pub use self::connection_error_generated::*;
    mod connection_message_header_generated;
    pub use self::connection_message_header_generated::*;
  } // connection
  pub mod data_feed {
    use super::*;
    pub mod device_data {
  ...
  pub mod driver_protocol {
    use super::*;
    mod registration_status_generated;
    pub use self::registration_status_generated::*;
    ...
    mod registration_available_generated;
    pub use self::registration_available_generated::*;
    mod register_driver_generated;
    pub use self::register_driver_generated::*;
    mod driver_registration_response_generated;
    pub use self::driver_registration_response_generated::*;
