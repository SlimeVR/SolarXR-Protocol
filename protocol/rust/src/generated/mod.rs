...
pub mod solarxr_protocol {
  ...
  pub mod rpc {
    ...
    mod model_settings_request_generated;
    pub use self::model_settings_request_generated::*;
    mod model_settings_response_generated;
    pub use self::model_settings_response_generated::*;
    mod change_model_settings_request_generated;
    pub use self::change_model_settings_request_generated::*;
