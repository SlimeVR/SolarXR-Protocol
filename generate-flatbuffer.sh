...
rm -rf protocol/cpp/include/solarxr_protocol/generated && flatc --cpp --scoped-enums --gen-all -o protocol/cpp/include/solarxr_protocol/generated -I ./protocol/flatbuffers/ ./protocol/flatbuffers/all.fbs && \
